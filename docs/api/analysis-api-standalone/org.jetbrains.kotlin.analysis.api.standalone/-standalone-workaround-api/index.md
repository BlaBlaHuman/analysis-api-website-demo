...
<span class="kd">annotation class </span><a href="index.html">StandaloneWorkaroundApi</a>
</span></code></pre></div>Marks an API as a workaround. Before such an API is used, the user should read its documentation to understand its purpose and tradeoffs.
