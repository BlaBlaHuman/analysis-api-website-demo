...
<span class="kd">val </span><a href="index.html#none">NONE</a><span class="o">: </span><a href="../index.html">StatementFilter</a>
</span></code></pre></div>
</div>
...
A [`StatementFilter`](../index.md) that applies no filtering (keeps every statement).
