...
<span class="kd">interface </span><a href="index.html">KotlinConstructorStub</a><span class="o"><</span><a href="index.html">T</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.psi/-kt-constructor/index.html">KtConstructor</a><span class="o"><</span><a href="index.html">T</a><span class="o">></span><span class="o">></span> : <a href="../-kotlin-callable-stub-base/index.html">KotlinCallableStubBase</a><span class="o"><</span><a href="index.html">T</a><span class="o">> </span>, <a href="../-kotlin-declaration-with-body-stub/index.html">KotlinDeclarationWithBodyStub</a><span class="o"><</span><a href="index.html">T</a><span class="o">> </span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-kotlin-property-accessor-stub/index.html#hasbody">hasBody</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-kotlin-property-accessor-stub/index.html#hasnoexpressionbody">hasNoExpressionBody</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isdelegatedcalltothis">isDelegatedCallToThis</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isexplicitdelegationcall">isExplicitDelegationCall</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-kotlin-property-accessor-stub/index.html#mayhavecontract">mayHaveContract</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the declaration may have a contract. <strong>false</strong> means that the declaration definitely has no contract, but <strong>true</strong> doesn't guarantee that the declaration has a contract.
