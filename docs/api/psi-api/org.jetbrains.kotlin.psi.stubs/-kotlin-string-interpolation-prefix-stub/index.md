...
tags:
 - jvm
title: "KotlinStringInterpolationPrefixStub"
---
...
<span class="kd">interface </span><a href="index.html">KotlinStringInterpolationPrefixStub</a> : <a href="../-kotlin-stub-element/index.html">KotlinStubElement</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi/-kt-string-interpolation-prefix/index.html">KtStringInterpolationPrefix</a><span class="o">> </span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#dollarsigncount">dollarSignCount</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a>
</span></code></pre></div>
</div>
...
For example, a single `$` in string interpolation would have count of 1, while `$$` would have count of 2.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="../-kotlin-block-string-template-entry-stub/index.html#psi">psi</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.psi/-kt-string-interpolation-prefix/index.html">KtStringInterpolationPrefix</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-kotlin-block-string-template-entry-stub/index.html#getpsi"><span class="nf">getPsi</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.psi/-kt-string-interpolation-prefix/index.html">KtStringInterpolationPrefix</a><span class="o">?</span>
</span></code></pre></div>
</div>
