...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">KDocSection</a> : <a href="../-k-doc-tag/index.html">KDocTag</a>, ContributedReferenceHost, PsiLanguageInjectionHost
</span></code></pre></div>The part of a doc comment which describes a single class, method or property produced by the element being documented. For example, the doc comment of a class can have sections for the class itself, its primary constructor and each of the properties defined in the primary constructor.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#isvalidhost"><span class="nf">isValidHost</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#isvalidhost">isValidHost</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-k-doc-tag/index.html#knowntag">knownTag</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.kdoc.parser/-k-doc-known-tag/index.html">KDocKnownTag</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The [`KDocKnownTag`](../../org.jetbrains.kotlin.kdoc.parser/-k-doc-known-tag/index.md) this tag corresponds to, or `null` if the tag name is not recognized or this is the default section.


</div>

</div>
### [`language`](../-k-doc-tag/index.md#language)
...
<span class="kd">open </span><span class="kd">override </span><span class="kd">val </span><a href="../-k-doc-tag/index.html#language">language</a><span class="o">: </span>Language
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">val </span><a href="../-k-doc-tag/index.html#presentation">presentation</a><span class="o">: </span>ItemPresentation<span class="o">?</span>
</span></code></pre></div>
</div>
...
## Functions
### [`accept`](../-k-doc-tag/index.md#accept)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-k-doc-tag/index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> PsiElementVisitor<span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createliteraltextescaper"><span class="nf">createLiteralTextEscaper</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>LiteralTextEscaper<span class="o"><</span><span class="kd">out </span>PsiLanguageInjectionHost<span class="o">></span>
</span></code></pre></div>
</div>

</div>
### [`delete`](../-k-doc-tag/index.md#delete)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-k-doc-tag/index.html#delete"><span class="nf">delete</span></a><span class="p">(</span><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html#findtagbyname"><span class="nf">findTagByName</span></a><span class="p">(</span>name<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a><span class="p">)</span><span class="o">: </span><a href="../-k-doc-tag/index.html">KDocTag</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the first tag in this section whose [`name`](../-k-doc-tag/index.md#getname) equals the given [`name`](index.md#findtagbyname) (without the leading `@`), or `null` if there is none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html#findtagsbyname"><span class="nf">findTagsByName</span></a><span class="p">(</span>name<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-k-doc-tag/index.html">KDocTag</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns all tags in this section whose [`name`](../-k-doc-tag/index.md#getname) equals the given [`name`](index.md#findtagsbyname) (without the leading `@`), in source order.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#getcontent"><span class="nf">getContent</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
Returns the content of this tag (all text following the tag name and the subject if present, with leading asterisks removed).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-k-doc-tag/index.html#getcopyableuserdata">T</a><span class="o">> </span><a href="../-k-doc-tag/index.html#getcopyableuserdata"><span class="nf">getCopyableUserData</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> key<span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Key<span class="o"><</span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/get-copyable-user-data.html">T</a><span class="o">?</span><span class="o">></span><span class="p">)</span><span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/get-copyable-user-data.html">T</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the name of the section (the name of the doc tag introducing the section, or null for the default section).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#getreference"><span class="nf">getReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiReference<span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-k-doc-tag/index.html#getsubjectlink"><span class="nf">getSubjectLink</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-k-doc-link/index.html">KDocLink</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the [`link`](../-k-doc-link/index.md) naming the entity documented by this tag (for example, the parameter name after `@param`), or `null` if this tag has no subject.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#getsubjectname"><span class="nf">getSubjectName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the name of the entity documented by this tag (for example, the name of the parameter for the @param tag), or null if this tag does not document any specific entity.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-k-doc-tag/index.html#getuserdata">T</a><span class="o">> </span><a href="../-k-doc-tag/index.html#getuserdata"><span class="nf">getUserData</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> key<span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Key<span class="o"><</span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/get-user-data.html">T</a><span class="o">?</span><span class="o">></span><span class="p">)</span><span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/get-user-data.html">T</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-k-doc-tag/index.html#navigationrequest"><span class="nf">navigationRequest</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><span class="se">@</span><span class="se">Nullable</span> NavigationRequest<span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-k-doc-tag/index.html#putcopyableuserdata">T</a><span class="o">> </span><a href="../-k-doc-tag/index.html#putcopyableuserdata"><span class="nf">putCopyableUserData</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> key<span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Key<span class="o"><</span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/put-copyable-user-data.html">T</a><span class="o">?</span><span class="o">></span><span class="p">, </span>value<span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/put-copyable-user-data.html">T</a><span class="o">?</span><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-k-doc-tag/index.html#putuserdata">T</a><span class="o">> </span><a href="../-k-doc-tag/index.html#putuserdata"><span class="nf">putUserData</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> key<span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Key<span class="o"><</span><a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/put-user-data.html">T</a><span class="o">?</span><span class="o">></span><span class="p">, </span><span class="se">@</span><span class="se">Nullable</span> value<span class="o">: </span><span class="se">@</span><span class="se">Nullable</span> <a href="../../../psi-api/org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-section/put-user-data.html">T</a><span class="o">?</span><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-k-doc-tag/index.html#tostring"><span class="nf">toString</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
