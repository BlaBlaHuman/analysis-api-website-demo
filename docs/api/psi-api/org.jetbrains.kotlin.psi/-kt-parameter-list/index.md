...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtParameterList</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtParameterList</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>Represents a list of parameters in various contexts. 

### Function parameters (including constructors and property accessors):
```java
...
#### See also
 ...
 - [`getOwnerFunction()`](index.md#getownerfunction)
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getfirstcomma"><span class="nf">getFirstComma</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the first comma separating parameters, or `#!java null` if there is at most one parameter.
...
Returns the opening parenthesis, or `#!java null` if it is absent (for example, a parenthesis-less lambda parameter list).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getownerfunction"><span class="nf">getOwnerFunction</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-declaration-with-body/index.html">KtDeclarationWithBody</a>
</span></code></pre></div>
</div>
...
Returns the function-like declaration that owns this parameter list, or `#!java null` if the list belongs to a function type (which is not a declaration).
...
Returns the closing parenthesis, or `#!java null` if it is absent (for example, a parenthesis-less lambda parameter list).
...
Returns the trailing comma after the last parameter, or `#!java null` if there is none.
