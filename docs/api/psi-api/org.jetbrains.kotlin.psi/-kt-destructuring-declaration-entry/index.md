...
tags:
 - jvm
title: "KtDestructuringDeclarationEntry"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtDestructuringDeclarationEntry</a> : <a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-named-declaration-not-stubbed/index.html">KtNamedDeclarationNotStubbed</a>, <a href="../-kt-variable-declaration/index.html">KtVariableDeclaration</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents a single entry in a destructuring declaration. 
...
Always `#!java null`: a destructuring entry has no fully qualified name.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getinitializer"><span class="nf">getInitializer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-name-reference-expression/index.html">KtNameReferenceExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getname"><span class="nf">getName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getnameidentifier"><span class="nf">getNameIdentifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getownvalorvarkeyword"><span class="nf">getOwnValOrVarKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
the PSI element for the val or var keyword of the entry itself or null. Only entries of full form destructuring declarations have their own val or var keyword.
...
Always `#!java null`: a destructuring entry cannot have an extension receiver.
...
Always `#!java null`: a destructuring entry cannot have a `#!java where` clause.
...
Always `#!java null`: a destructuring entry cannot declare type parameters.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettypereference"><span class="nf">getTypeReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvalorvarkeyword"><span class="nf">getValOrVarKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Always `#!java null`: a destructuring entry has no value parameter list.
