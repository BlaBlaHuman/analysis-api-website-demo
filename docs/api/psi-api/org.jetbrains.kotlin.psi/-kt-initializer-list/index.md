...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtInitializerList</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtInitializerList</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>Represents the initializer list for an `#!java enum` entry with constructor arguments. 
...
Returns the initializer entries (the superclass constructor call carrying the arguments). In valid code this is a single entry; a longer list only occurs in erroneous code.
