...
tags:
 - jvm
title: "KtDelegatedSuperTypeEntry"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtDelegatedSuperTypeEntry</a> : <a href="../-kt-super-type-list-entry/index.html">KtSuperTypeListEntry</a>
</span></code></pre></div>Represents an interface delegation in the super type list using the `#!java by` keyword. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getbykeywordnode"><span class="nf">getByKeywordNode</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>ASTNode
</span></code></pre></div>
</div>
...
Returns the expression that provides the delegate instance (the part after `#!java by`), or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-super-type-list-entry/index.html#gettypereference"><span class="nf">getTypeReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
