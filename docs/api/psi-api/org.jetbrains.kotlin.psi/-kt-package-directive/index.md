...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtPackageDirective</a> : <a href="../-kt-modifier-list-owner-stub/index.html">KtModifierListOwnerStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtPackageDirective</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>Represents a `#!java package` directive that declares the package of a Kotlin file. 
...
Returns the fully qualified package name, or ROOT for the root package.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getfqname"><span class="nf">getFqName</span></a><span class="p">(</span>nameExpression<span class="o">: </span><a href="../-kt-simple-name-expression/index.html">KtSimpleNameExpression</a><span class="p">)</span><span class="o">: </span>FqName
</span></code></pre></div>
</div>
...
This is useful for resolving a click on an intermediate segment of a dotted package name to the corresponding partial package.
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getlastreferenceexpression"><span class="nf">getLastReferenceExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-simple-name-expression/index.html">KtSimpleNameExpression</a>
</span></code></pre></div>
</div>
...
Returns the last (innermost) name segment of the package, or `#!java null` for the root package.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getnameasname"><span class="nf">getNameAsName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
Returns the last name segment as a Name, or ROOT_PACKAGE for the root package.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getnameidentifier"><span class="nf">getNameIdentifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the identifier token of the last name segment, or `#!java null` for the root package.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getpackagekeyword"><span class="nf">getPackageKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the `#!java package` keyword token, or `#!java null` if it is absent (for an implicit root package).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getpackagenameexpression"><span class="nf">getPackageNameExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the expression denoting the package name, or `#!java null` for the root package. This is either a [`KtSimpleNameExpression`](../-kt-simple-name-expression/index.md) (a single-segment package) or a [`KtDotQualifiedExpression`](../-kt-dot-qualified-expression/index.md) (a dotted name).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getpackagenames"><span class="nf">getPackageNames</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-simple-name-expression/index.html">KtSimpleNameExpression</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the individual name segments of the package, from the outermost to the innermost (for example, `#!java com`, `#!java example`, `#!java myapp`). Returns an empty list for the root package.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getqualifiedname"><span class="nf">getQualifiedName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#isroot"><span class="nf">isRoot</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this directive declares the root package (an empty or absent package name).
