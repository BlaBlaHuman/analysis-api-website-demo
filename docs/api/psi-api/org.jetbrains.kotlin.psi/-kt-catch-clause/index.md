...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtCatchClause</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>
</span></code></pre></div>Represents a `#!java catch` clause in a `#!java try` expression. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getcatchbody"><span class="nf">getCatchBody</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the body executed when the exception is caught, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getcatchparameter"><span class="nf">getCatchParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-parameter/index.html">KtParameter</a>
</span></code></pre></div>
</div>
...
Returns the caught exception parameter, or `#!java null` if it is absent or malformed (not exactly one parameter).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getparameterlist"><span class="nf">getParameterList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-parameter-list/index.html">KtParameterList</a>
</span></code></pre></div>
</div>
...
Returns the parameter list holding the caught exception parameter, or `#!java null` if it is absent in incomplete code.
