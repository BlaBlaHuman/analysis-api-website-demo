...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtDeclarationImpl</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>, <a href="../-kt-declaration/index.html">KtDeclaration</a>
</span></code></pre></div>Base implementation of [`KtDeclaration`](../-kt-declaration/index.md) backed directly by the AST tree. 

This is an internal implementation base class of the Kotlin PSI, used by declaration types that are never represented by a stub. It is not intended for direct use or subclassing outside of the PSI implementation. For declarations that may also be backed by a stub, see [`KtDeclarationStub`](../-kt-declaration-stub/index.md).
