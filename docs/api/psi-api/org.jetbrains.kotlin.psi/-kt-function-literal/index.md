...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtFunctionLiteral</a> : <a href="../-kt-function-not-stubbed/index.html">KtFunctionNotStubbed</a>
</span></code></pre></div>Represents the body of a lambda expression, containing parameters and the function body. 
...
### [`Companion`](../-kt-throw-expression/index.md#companion)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-throw-expression/index.html#companion">Companion</a><span class="o">: </span><a href="../-kt-expression-impl/-companion/index.html">KtExpressionImpl.Companion</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-throw-expression/index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span>PsiElementVisitor<span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-kt-function-not-stubbed/index.html#accept">R</a><span class="p">, </span><a href="../-kt-function-not-stubbed/index.html#accept">D</a><span class="o">> </span><a href="../-kt-function-not-stubbed/index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><a href="../-kt-visitor/index.html">KtVisitor</a><span class="o"><</span><a href="../-kt-function-not-stubbed/index.html#accept">R</a><span class="p">, </span><a href="../-kt-function-not-stubbed/index.html#accept">D</a><span class="o">></span><span class="p">, </span>data<span class="o">: </span><a href="../-kt-function-not-stubbed/index.html#accept">D</a><span class="p">)</span><span class="o">: </span><a href="../-kt-function-not-stubbed/index.html#accept">R</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-kt-throw-expression/index.html#acceptchildren">D</a><span class="o">> </span><a href="../-kt-throw-expression/index.html#acceptchildren"><span class="nf">acceptChildren</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><a href="../-kt-visitor/index.html">KtVisitor</a><span class="o"><</span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/Void.html">Void</a><span class="p">, </span><a href="../-kt-throw-expression/index.html#acceptchildren">D</a><span class="o">></span><span class="p">, </span>data<span class="o">: </span><a href="../-kt-throw-expression/index.html#acceptchildren">D</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
### [`findLabelAndCall`](../../org.jetbrains.kotlin.psi.psiUtil/find-label-and-call.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtFunctionLiteral</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/find-label-and-call.html"><span class="nf">findLabelAndCall</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-pair/index.html">Pair</a><span class="o"><</span>Name<span class="o">?</span><span class="p">, </span><a href="../-kt-call-expression/index.html">KtCallExpression</a><span class="o">?</span><span class="o">></span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getannotationentries"><span class="nf">getAnnotationEntries</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-annotation-entry/index.html">KtAnnotationEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getarrow"><span class="nf">getArrow</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the `#!java ->` arrow separating the parameters from the body, or `#!java null` if the lambda declares no explicit parameters.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getbodyblockexpression"><span class="nf">getBodyBlockExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-block-expression/index.html">KtBlockExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getbodyexpression"><span class="nf">getBodyExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-block-expression/index.html">KtBlockExpression</a>
</span></code></pre></div>
</div>
...
A function literal's body is always a [`KtBlockExpression`](../-kt-block-expression/index.md) (a lambda cannot have an expression body).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getcolon"><span class="nf">getColon</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getcontainingfile"><span class="nf">getContainingFile</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiFile
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getcontext"><span class="nf">getContext</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getcontractdescription"><span class="nf">getContractDescription</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-contract-effect-list/index.html">KtContractEffectList</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getdoccomment"><span class="nf">getDocComment</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.kdoc.psi.api/-k-doc/index.html">KDoc</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getequalstoken"><span class="nf">getEqualsToken</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Always `#!java null`: a function literal cannot have an expression body, so there is no `#!java =` token.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getfqname"><span class="nf">getFqName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>FqName
</span></code></pre></div>
</div>
...
Always `#!java null`: a function literal is anonymous and has no fully qualified name.
...
### [`getLanguage`](../-kt-throw-expression/index.md#getlanguage)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-throw-expression/index.html#getlanguage"><span class="nf">getLanguage</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Language
</span></code></pre></div>
</div>
...
Returns the opening brace `#!java {` of the lambda.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getmanager"><span class="nf">getManager</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiManagerEx
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getmodifierlist"><span class="nf">getModifierList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-modifier-list/index.html">KtModifierList</a>
</span></code></pre></div>
</div>
...
### [`getNameAsName`](../-kt-function-not-stubbed/index.md#getnameasname)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getnameasname"><span class="nf">getNameAsName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
### [`getNameAsSafeName`](../-kt-function-not-stubbed/index.md#getnameassafename)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getnameassafename"><span class="nf">getNameAsSafeName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
Returns the name of this declaration, or a special "no name provided" Name when the declaration is anonymous or its name is missing.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getnameidentifier"><span class="nf">getNameIdentifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Always `#!java null`: a function literal is anonymous and has no name identifier.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getnode"><span class="nf">getNode</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> ASTNode
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getparent"><span class="nf">getParent</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-tag/index.html#getproject"><span class="nf">getProject</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><span class="se">@</span><span class="se">NotNull</span> Project
</span></code></pre></div>
</div>
...
Returns the closing brace `#!java }` of the lambda, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getreceivertypereference"><span class="nf">getReceiverTypeReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettextoffset"><span class="nf">getTextOffset</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a>
</span></code></pre></div>
</div>
...
### [`getTypeConstraintList`](../-kt-function-not-stubbed/index.md#gettypeconstraintlist)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettypeconstraintlist"><span class="nf">getTypeConstraintList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-constraint-list/index.html">KtTypeConstraintList</a>
</span></code></pre></div>
</div>
...
### [`getTypeConstraints`](../-kt-function-not-stubbed/index.md#gettypeconstraints)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettypeconstraints"><span class="nf">getTypeConstraints</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-type-constraint/index.html">KtTypeConstraint</a><span class="o">></span>
</span></code></pre></div>
</div>
...
### [`getTypeParameterList`](../-kt-function-not-stubbed/index.md#gettypeparameterlist)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettypeparameterlist"><span class="nf">getTypeParameterList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-parameter-list/index.html">KtTypeParameterList</a>
</span></code></pre></div>
</div>
...
### [`getTypeParameters`](../-kt-function-not-stubbed/index.md#gettypeparameters)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettypeparameters"><span class="nf">getTypeParameters</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-type-parameter/index.html">KtTypeParameter</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#gettypereference"><span class="nf">getTypeReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getusescope"><span class="nf">getUseScope</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>SearchScope
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getvalueparameterlist"><span class="nf">getValueParameterList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-parameter-list/index.html">KtParameterList</a>
</span></code></pre></div>
</div>
...
Always `#!java false`: the block/expression-body distinction does not apply to a function literal.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#hasdeclaredreturntype"><span class="nf">hasDeclaredReturnType</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#hasparameterspecification"><span class="nf">hasParameterSpecification</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if the lambda contains an explicit parameter specification (there is an `#!java ->` arrow), including an explicitly empty one. Without an arrow, the syntax may represent either a zero-parameter lambda or a lambda with an implicit `#!java it` parameter, depending on the expected function type.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#islocal"><span class="nf">isLocal</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#mayhavecontract"><span class="nf">mayHaveContract</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-throw-expression/index.html#replace"><span class="nf">replace</span></a><span class="p">(</span>newElement<span class="o">: </span>PsiElement<span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#setname"><span class="nf">setName</span></a><span class="p">(</span><span class="se">@</span><span class="se">NonNls</span> <span class="se">@</span><span class="se">NotNull</span> name<span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#settypereference"><span class="nf">setTypeReference</span></a><span class="p">(</span><span class="se">@</span><span class="se">Nullable</span> typeRef<span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
### [`toString`](../-kt-throw-expression/index.md#tostring)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-throw-expression/index.html#tostring"><span class="nf">toString</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
