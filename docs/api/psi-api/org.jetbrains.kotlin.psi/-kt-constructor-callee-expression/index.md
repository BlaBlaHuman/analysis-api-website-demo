...
tags:
 - jvm
title: "KtConstructorCalleeExpression"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtConstructorCalleeExpression</a> : <a href="../-kt-expression-impl-stub/index.html">KtExpressionImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtConstructorCalleeExpression</a><span class="o">></span><span class="o">> </span>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents the callee part in a constructor invocation, such as in annotations or super type calls. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getconstructorreferenceexpression"><span class="nf">getConstructorReferenceExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-simple-name-expression/index.html">KtSimpleNameExpression</a>
</span></code></pre></div>
</div>
...
Returns the reference expression naming the invoked constructor's class, or `#!java null` if it cannot be determined (for example, when the callee is not a simple user type).
...
Returns the type reference naming the class being constructed, or `#!java null` if it is absent in incomplete code.
