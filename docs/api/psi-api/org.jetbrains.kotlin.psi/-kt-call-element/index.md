...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KtCallElement</a> : <a href="../-kt-element/index.html">KtElement</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents an element with call syntax: a callee together with type arguments and value arguments. 

This is the common base type for call-shaped nodes such as [`KtCallExpression`](../-kt-call-expression/index.md) (a function call), [`KtAnnotationEntry`](../-kt-annotation-entry/index.md) (an annotation application), [`KtSuperTypeCallEntry`](../-kt-super-type-call-entry/index.md) (a superclass constructor call), and [`KtConstructorDelegationCall`](../-kt-constructor-delegation-call/index.md) (a `#!java this(...)`/`#!java super(...)` delegation).

#### See also


 - [`KtResolvableCall`](../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.md): for resolving the call to its target
...
<span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getcalleeexpression"><span class="nf">getCalleeExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the trailing lambda arguments written outside the parentheses. Normally there is at most one; a longer list only occurs in erroneous code. Returns an empty list if there are none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#gettypeargumentlist"><span class="nf">getTypeArgumentList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-argument-list/index.html">KtTypeArgumentList</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getvalueargumentlist"><span class="nf">getValueArgumentList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-value-argument-list/index.html">KtValueArgumentList</a>
</span></code></pre></div>
</div>
