...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhenConditionInRange</a> : <a href="../-kt-when-condition/index.html">KtWhenCondition</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents a `#!java when` condition that checks membership using `#!java in` or `#!java !in`. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getoperationreference"><span class="nf">getOperationReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-operation-reference-expression/index.html">KtOperationReferenceExpression</a>
</span></code></pre></div>
</div>
...
Returns the `#!java in` or `#!java !in` operation sign as a reference expression.
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getrangeexpression"><span class="nf">getRangeExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the range or container expression tested against (the part after `#!java in`), or `#!java null` if it is absent in incomplete code.
...
Returns `#!java true` if this is a `#!java !in` (not-in) check rather than a plain `#!java in` check.
