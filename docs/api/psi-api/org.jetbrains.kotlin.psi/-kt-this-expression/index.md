...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtThisExpression</a> : <a href="../-kt-instance-expression-with-label/index.html">KtInstanceExpressionWithLabel</a>
</span></code></pre></div>Represents a `#!java this` expression that refers to the current receiver. 
