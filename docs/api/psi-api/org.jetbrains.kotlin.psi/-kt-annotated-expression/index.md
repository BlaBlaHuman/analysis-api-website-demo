...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtAnnotatedExpression</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>, <a href="../-kt-annotated/index.html">KtAnnotated</a>, <a href="../-kt-annotations-container/index.html">KtAnnotationsContainer</a>
</span></code></pre></div>Represents an expression with annotations applied to it. 
...
Returns the expression the annotations are applied to, or `#!java null` if it is absent in incomplete code.
