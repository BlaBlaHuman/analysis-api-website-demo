...
tags:
 - jvm
title: "KtContextParameterList"
---

# KtContextParameterList
...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtContextParameterList</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtContextParameterList</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>The class representing a context parameter list in a declaration or functional type.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-context-receiver-list/index.html#contextparameters">contextParameters</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-parameter/index.html">KtParameter</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Note that [`KtFunctionType`](../-kt-function-type/index.md) still uses [`contextReceivers`](../-kt-context-receiver-list/index.md#contextreceivers) for compatibility with K1.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-context-receiver-list/index.html#ownerdeclaration">ownerDeclaration</a><span class="o">: </span><a href="../-kt-declaration/index.html">KtDeclaration</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the owner declaration of the context parameter list. The owner would be null in the case of context parameter on a functional type.

```kotlin
fun foo(action: context(Int) () -> Unit
```

In this case the owner for `context(Int)` will be <strong>null</strong>.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-context-receiver-list/index.html#contextreceivers"><span class="nf">contextReceivers</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-context-receiver/index.html">KtContextReceiver</a><span class="o">></span>
</span></code></pre></div>
</div>
...
This API is obsolete for declarations ([`contextParameters`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-context-parameter-list/context-parameters.md) has to be used instead), but it is still used for [`KtFunctionType`](../-kt-function-type/index.md) for compatibility with K1.

This API will be removed in the future (together with [`KtContextReceiver`](../-kt-context-receiver/index.md)).

**See also**



 - [`contextParameters`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-context-parameter-list/context-parameters.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-context-receiver-list/index.html#typereferences"><span class="nf">typeReferences</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-type-reference/index.html">KtTypeReference</a><span class="o">></span>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`contextReceivers`](../-kt-context-receiver-list/index.md#contextreceivers)
