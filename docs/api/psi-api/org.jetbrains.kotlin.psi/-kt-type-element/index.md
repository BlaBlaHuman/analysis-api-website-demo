...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KtTypeElement</a> : <a href="../-kt-element/index.html">KtElement</a>
</span></code></pre></div>Represents the actual type syntax inside a [`KtTypeReference`](../-kt-type-reference/index.md), stripped of any leading annotations and modifiers. 

This is the common base type for the concrete type-syntax nodes, such as [`KtUserType`](../-kt-user-type/index.md) (`#!java Foo<Bar>`), [`KtNullableType`](../-kt-nullable-type/index.md) (`#!java Foo?`), [`KtFunctionType`](../-kt-function-type/index.md) (`#!java (Int) -> String`), and [`KtDynamicType`](../-kt-dynamic-type/index.md) (`#!java dynamic`). A [`KtTypeReference`](../-kt-type-reference/index.md) wraps exactly one [`KtTypeElement`](index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-function-type/index.html#array_factory">ARRAY_FACTORY</a><span class="o">: </span>ArrayFactory<span class="o"><</span><a href="index.html">KtTypeElement</a><span class="o">></span>
</span></code></pre></div>
</div>
...
A factory for creating arrays of [`KtTypeElement`](index.md), used by the PSI child-access machinery.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-function-type/index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtTypeElement</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">tailrec </span><span class="kd">fun </span><a href="index.html">KtTypeElement</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/unwrap-nullability.html"><span class="nf">unwrapNullability</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="index.html">KtTypeElement</a><span class="o">?</span>
</span></code></pre></div>
</div>
