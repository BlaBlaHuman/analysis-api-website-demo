...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtFinallySection</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>, <a href="../-kt-statement-expression/index.html">KtStatementExpression</a>
</span></code></pre></div>Represents a `#!java finally` block in a `#!java try` expression. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getfinalexpression"><span class="nf">getFinalExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-block-expression/index.html">KtBlockExpression</a>
</span></code></pre></div>
</div>
...
Returns the block executed in the `#!java finally` section.
