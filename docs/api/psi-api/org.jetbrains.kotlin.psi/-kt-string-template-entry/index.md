...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtStringTemplateEntry</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-with-text-stub/index.html">KotlinPlaceHolderWithTextStub</a><span class="o"><</span><span class="kd">out </span><a href="index.html">KtStringTemplateEntry</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>Represents a single entry of a [`KtStringTemplateExpression`](../-kt-string-template-expression/index.md), that is, one segment of a string literal. 

A string is split into consecutive entries: plain literal text ([`KtLiteralStringTemplateEntry`](../-kt-literal-string-template-entry/index.md)), escape sequences ([`KtEscapeStringTemplateEntry`](../-kt-escape-string-template-entry/index.md)), and interpolated expressions ([`KtStringTemplateEntryWithExpression`](../-kt-string-template-entry-with-expression/index.md)). 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-with-text-stub/index.html">KotlinPlaceHolderWithTextStub</a><span class="o"><</span><span class="kd">out </span><a href="index.html">KtStringTemplateEntry</a><span class="o">></span><span class="p">, </span><span class="se">@</span><span class="se">NotNull</span> elementType<span class="o">: </span>IElementType<span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-block-string-template-entry/index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtStringTemplateEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
