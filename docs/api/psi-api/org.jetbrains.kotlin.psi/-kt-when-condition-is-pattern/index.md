...
tags:
 - jvm
title: "KtWhenConditionIsPattern"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhenConditionIsPattern</a> : <a href="../-kt-when-condition/index.html">KtWhenCondition</a>
</span></code></pre></div>Represents a `#!java when` condition that performs a type check using `#!java is` or `#!java !is`. 
...
Returns `#!java true` if this is a `#!java !is` (negated) type check rather than a plain `#!java is` check.
