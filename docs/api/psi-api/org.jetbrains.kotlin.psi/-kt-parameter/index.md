...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtParameter</a> : <a href="../-kt-named-declaration-stub/index.html">KtNamedDeclarationStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-parameter-stub/index.html">KotlinParameterStub</a><span class="o">> </span>, <a href="../-kt-callable-declaration/index.html">KtCallableDeclaration</a>, <a href="../-kt-val-var-keyword-owner/index.html">KtValVarKeywordOwner</a>
</span></code></pre></div>Represents a parameter declaration in various contexts. 

### Function parameter (including constructors and property accessors):
```java
...
#### See also
 ...
 - [`isLoopParameter()`](index.md#isloopparameter)
 - [`isCatchParameter()`](index.md#iscatchparameter)
 - [`isLambdaParameter()`](index.md#islambdaparameter)
 - [`isFunctionTypeParameter()`](index.md#isfunctiontypeparameter)
 - [`isContextParameter()`](index.md#iscontextparameter)
 - [`hasValOrVar()`](index.md#hasvalorvar)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-parameter-stub/index.html">KotlinParameterStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtParameter</a><span class="o">></span>
</span></code></pre></div>
</div>
...
a non-null list of [`KtParameter`](index.md) representing the context parameters. Returns an empty list if no context parameters are declared.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getdefaultvalue"><span class="nf">getDefaultValue</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the default value expression, or `#!java null` if this parameter has no default value.


</div>

</div>
### getDestructuringDeclaration
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getdestructuringdeclaration"><span class="nf">getDestructuringDeclaration</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-destructuring-declaration/index.html">KtDestructuringDeclaration</a>
</span></code></pre></div>
</div>
...
Returns the destructuring declaration if this parameter destructures its argument (as in a lambda `#!java { (a, b) -> ... }`), or `#!java null` otherwise.
...
Returns the `#!java =` token preceding the default value, or `#!java null` if this parameter has no default value.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getownerdeclaration"><span class="nf">getOwnerDeclaration</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-declaration/index.html">KtDeclaration</a>
</span></code></pre></div>
</div>
...
the parameter's owner declaration or null if it is from a functional type

**See also**



 - [`KtParameterList`](../-kt-parameter-list/index.md#getownerfunction)
 - [`KtContextParameterList`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-context-parameter-list/get-owner-declaration.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getownerfunction"><span class="nf">getOwnerFunction</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-declaration-with-body/index.html">KtDeclarationWithBody</a>
</span></code></pre></div>
</div>
...
Returns the function-like declaration this parameter belongs to, or `#!java null` if it is not a value parameter of a function (for example, a context parameter or a parameter of a function type). See [`getOwnerDeclaration`](index.md#getownerdeclaration) for the more general accessor.
...
Always `#!java null`: a parameter cannot have an extension receiver.
...
Always `#!java null`: a parameter cannot have a `#!java where` clause.
...
Always `#!java null`: a parameter cannot declare type parameters.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvalorvarkeyword"><span class="nf">getValOrVarKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Always `#!java null`: a parameter does not itself take value parameters.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-named-declaration/index.html">KtNamedDeclaration</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/get-value-parameters.html"><span class="nf">getValueParameters</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="index.html">KtParameter</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#hasdefaultvalue"><span class="nf">hasDefaultValue</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter declares a default value.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#hasvalorvar"><span class="nf">hasValOrVar</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter is declared with a `#!java val` or `#!java var` keyword (a primary constructor property parameter).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#iscatchparameter"><span class="nf">isCatchParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter is the exception parameter of a `#!java catch` clause.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#iscontextparameter"><span class="nf">isContextParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
`#!java true` if this [`KtParameter`](index.md) is a context parameter.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#isfunctiontypeparameter"><span class="nf">isFunctionTypeParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
`#!java true` if this [`KtParameter`](index.md) is a parameter of a function type.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#islambdaparameter"><span class="nf">isLambdaParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
`#!java true` if this [`KtParameter`](index.md) is a parameter of a lambda.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#isloopparameter"><span class="nf">isLoopParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter is the loop variable of a `#!java for` loop (as in `#!java for (item in list)`).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#ismutable"><span class="nf">isMutable</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter is a mutable `#!java var` property parameter (only valid in a primary constructor).
...
### [`isPropertyParameter`](../../org.jetbrains.kotlin.psi.psiUtil/is-property-parameter.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtParameter</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/is-property-parameter.html"><span class="nf">isPropertyParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#isvararg"><span class="nf">isVarArg</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this parameter has the `#!java vararg` modifier.
