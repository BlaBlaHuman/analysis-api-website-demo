...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtArrayAccessExpression</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>, <a href="../-kt-reference-expression/index.html">KtReferenceExpression</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents an indexed access expression using square brackets. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getarrayexpression"><span class="nf">getArrayExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the expression being indexed (the part before `#!java [`), or `#!java null` if it is absent in incomplete code.
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getbracketranges"><span class="nf">getBracketRanges</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span>TextRange<span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getindexexpressions"><span class="nf">getIndexExpressions</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-expression/index.html">KtExpression</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the index expressions inside the brackets (there may be several, as in `#!java matrix[i, j]`); empty if there are none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getindicesnode"><span class="nf">getIndicesNode</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-container-node/index.html">KtContainerNode</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getleftbracket"><span class="nf">getLeftBracket</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the opening bracket `#!java [`, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getrightbracket"><span class="nf">getRightBracket</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the closing bracket `#!java ]`, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettrailingcomma"><span class="nf">getTrailingComma</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the trailing comma after the last index, or `#!java null` if there is none.
