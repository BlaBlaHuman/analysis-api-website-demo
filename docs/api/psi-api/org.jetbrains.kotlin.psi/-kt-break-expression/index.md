...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtBreakExpression</a> : <a href="../-kt-expression-with-label/index.html">KtExpressionWithLabel</a>, <a href="../-kt-statement-expression/index.html">KtStatementExpression</a>
</span></code></pre></div>Represents a `#!java break` expression that terminates the enclosing loop. 
