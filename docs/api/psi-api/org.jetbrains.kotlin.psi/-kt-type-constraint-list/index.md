...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtTypeConstraintList</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtTypeConstraintList</a><span class="o">></span><span class="o">> </span>
</span></code></pre></div>Represents a `#!java where` clause containing type constraints. 
...
Returns the constraints in this `#!java where` clause, in source order; empty if there are none.
