...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtBinaryExpression</a> : <a href="../-kt-expression-impl-stub/index.html">KtExpressionImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtBinaryExpression</a><span class="o">></span><span class="o">> </span>, <a href="../-kt-operation-expression/index.html">KtOperationExpression</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents a binary expression with a left operand, operator, and right operand. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-expression/index.html">KtExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/as-assignment.html"><span class="nf">asAssignment</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="index.html">KtBinaryExpression</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns this expression as a [`KtBinaryExpression`](index.md) if it is an assignment, or `null` otherwise.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-expression/index.html">KtExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/get-assignment-by-l-h-s.html"><span class="nf">getAssignmentByLHS</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="index.html">KtBinaryExpression</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Returns the left operand, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getoperationtoken"><span class="nf">getOperationToken</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>IElementType
</span></code></pre></div>
</div>
...
Returns the element type of the operator token (for example, `#!java PLUS` for `#!java +`).


</div>

</div>
### getOperationTokenOrNull
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getoperationtokenornull"><span class="nf">getOperationTokenOrNull</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>IElementType
</span></code></pre></div>
</div>
...
Returns the element type of the operator token, or `#!java null` if the operation reference is absent in incomplete or inconsistent PSI. 

Unlike [`getOperationToken`](index.md#getoperationtoken), this method does not throw when the operation token is absent.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getright"><span class="nf">getRight</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the right operand, or `#!java null` if it is absent in incomplete code.
...
### [`tryFlattenStringConcatenationArguments`](../../org.jetbrains.kotlin.psi.psiUtil/try-flatten-string-concatenation-arguments.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtBinaryExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/try-flatten-string-concatenation-arguments.html"><span class="nf">tryFlattenStringConcatenationArguments</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-string-template-expression/index.html">KtStringTemplateExpression</a><span class="o">></span><span class="o">?</span>
</span></code></pre></div>
</div>
...
### [`tryFlattenStringConcatenationDescendants`](../../org.jetbrains.kotlin.psi.psiUtil/try-flatten-string-concatenation-descendants.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtBinaryExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/try-flatten-string-concatenation-descendants.html"><span class="nf">tryFlattenStringConcatenationDescendants</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span>PsiElement<span class="o">></span><span class="o">?</span>
</span></code></pre></div>
</div>
