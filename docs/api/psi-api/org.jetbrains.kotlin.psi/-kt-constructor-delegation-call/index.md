...
tags:
 - jvm
title: "KtConstructorDelegationCall"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtConstructorDelegationCall</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>, <a href="../-kt-call-element/index.html">KtCallElement</a>
</span></code></pre></div>Represents a constructor delegation call to `#!java this()` or `#!java super()`. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getcalleeexpression"><span class="nf">getCalleeExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-constructor-delegation-reference-expression/index.html">KtConstructorDelegationReferenceExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getlambdaarguments"><span class="nf">getLambdaArguments</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-lambda-argument/index.html">KtLambdaArgument</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Always empty: a constructor delegation call (`#!java this(...)` / `#!java super(...)`) takes no trailing lambda arguments.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettypeargumentlist"><span class="nf">getTypeArgumentList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-argument-list/index.html">KtTypeArgumentList</a>
</span></code></pre></div>
</div>
...
Always `#!java null`: a constructor delegation call has no type argument list.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettypearguments"><span class="nf">getTypeArguments</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-type-projection/index.html">KtTypeProjection</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvalueargumentlist"><span class="nf">getValueArgumentList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-value-argument-list/index.html">KtValueArgumentList</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvaluearguments"><span class="nf">getValueArguments</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><span class="kd">out </span><a href="../-value-argument/index.html">ValueArgument</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#iscalltothis"><span class="nf">isCallToThis</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this delegates to another constructor of the same class (`#!java this(...)`), or `#!java false` if it delegates to a superclass constructor (`#!java super(...)`).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#isimplicit"><span class="nf">isImplicit</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
true if this delegation call is not present in the source code. Note that we always parse delegation calls for secondary constructors, even if there's no explicit call in the source (see parseSecondaryConstructor). class Foo { constructor(name: String) // <--- implicit constructor delegation call (empty element after RPAR)
