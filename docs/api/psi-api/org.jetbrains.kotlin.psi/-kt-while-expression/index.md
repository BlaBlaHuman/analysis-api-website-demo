...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhileExpression</a> : <a href="../-kt-while-expression-base/index.html">KtWhileExpressionBase</a>
</span></code></pre></div>Represents a `#!java while` loop that executes its body while the condition is true. 
