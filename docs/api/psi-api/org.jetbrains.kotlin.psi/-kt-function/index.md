...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KtFunction</a> : <a href="../-kt-declaration-with-body/index.html">KtDeclarationWithBody</a>, <a href="../-kt-callable-declaration/index.html">KtCallableDeclaration</a>
</span></code></pre></div>Represents a function: a named function, a function literal (lambda or anonymous function), or a constructor. 

This is the common base type for the concrete node types [`KtNamedFunction`](../-kt-named-function/index.md), [`KtFunctionLiteral`](../-kt-function-literal/index.md), and [`KtConstructor`](../-kt-constructor/index.md). As a [`KtCallableDeclaration`](../-kt-callable-declaration/index.md) it has value parameters, type parameters, and a return type, and as a [`KtDeclarationWithBody`](../-kt-declaration-with-body/index.md) it may have a block or expression body.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getbodyexpression"><span class="nf">getBodyExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
