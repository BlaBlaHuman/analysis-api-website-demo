...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">KtContextReceiverList</a> : <a href="../-kt-context-parameter-list/index.html">KtContextParameterList</a>
</span></code></pre></div>Represents a list of context receivers declared on a function, property, or class.
...
Use [`KtContextParameterList`](../-kt-context-parameter-list/index.md) instead.
...
Note that [`KtFunctionType`](../-kt-function-type/index.md) still uses [`contextReceivers`](index.md#contextreceivers) for compatibility with K1.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html#contextreceivers"><span class="nf">contextReceivers</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-context-receiver/index.html">KtContextReceiver</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html#typereferences"><span class="nf">typeReferences</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-kt-type-reference/index.html">KtTypeReference</a><span class="o">></span>
</span></code></pre></div>
</div>
