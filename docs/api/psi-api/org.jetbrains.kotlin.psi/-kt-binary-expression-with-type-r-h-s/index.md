...
tags:
 - jvm
title: "KtBinaryExpressionWithTypeRHS"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtBinaryExpressionWithTypeRHS</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>, <a href="../-kt-operation-expression/index.html">KtOperationExpression</a>
</span></code></pre></div>Represents a type cast expression using `#!java as` or `#!java as?`. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../-kt-expression/index.html">KtExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/get-binary-with-type-parent.html"><span class="nf">getBinaryWithTypeParent</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="index.html">KtBinaryExpressionWithTypeRHS</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getleft"><span class="nf">getLeft</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the operand being cast (the expression on the left of `#!java as`).
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getright"><span class="nf">getRight</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
Returns the target type reference (the type on the right of `#!java as`), or `#!java null` if it is absent in incomplete code.
