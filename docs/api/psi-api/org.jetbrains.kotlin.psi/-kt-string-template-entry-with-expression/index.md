...
tags:
 - jvm
title: "KtStringTemplateEntryWithExpression"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtStringTemplateEntryWithExpression</a> : <a href="../-kt-string-template-entry/index.html">KtStringTemplateEntry</a>
</span></code></pre></div>Represents a string template entry that interpolates an expression, using either the `#!java $name` or the `#!java ${...}` syntax. 

This is the common base for the concrete node types [`KtSimpleNameStringTemplateEntry`](../-kt-simple-name-string-template-entry/index.md) (`#!java $name`) and [`KtBlockStringTemplateEntry`](../-kt-block-string-template-entry/index.md) (`#!java ${expression}`). 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-with-text-stub/index.html">KotlinPlaceHolderWithTextStub</a><span class="o"><</span><span class="kd">out </span><a href="index.html">KtStringTemplateEntryWithExpression</a><span class="o">></span><span class="p">, </span><span class="se">@</span><span class="se">NotNull</span> elementType<span class="o">: </span>IElementType<span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-block-string-template-entry/index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="../-kt-string-template-entry/index.html">KtStringTemplateEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-block-string-template-entry/index.html#getexpression"><span class="nf">getExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
the child [`KtExpression`](../-kt-expression/index.md) or null if no expression is found
...
Returns a list of expressions from this entry. 
 ...
 The list size is 1 for valid code, so [`getExpression`](../-kt-block-string-template-entry/index.md#getexpression) should be preferred and this method should be used only to process potentially error code.

**Return**

list with expressions or empty

**See also**



 - [`getExpression`](../-kt-block-string-template-entry/index.md#getexpression)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-block-string-template-entry/index.html#gettext"><span class="nf">getText</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
