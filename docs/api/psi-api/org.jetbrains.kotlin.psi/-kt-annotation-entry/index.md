...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtAnnotationEntry</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-annotation-entry-stub/index.html">KotlinAnnotationEntryStub</a><span class="o">> </span>, <a href="../-kt-call-element/index.html">KtCallElement</a>
</span></code></pre></div>Represents a single annotation applied to a declaration or expression. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-annotation-entry-stub/index.html">KotlinAnnotationEntryStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtAnnotationEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getatsymbol"><span class="nf">getAtSymbol</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the `#!java @` symbol of the annotation, or `#!java null` if it is omitted (for example, in an annotation grouped under a shared use-site target, or in an array of annotation arguments).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getcalleeexpression"><span class="nf">getCalleeExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-constructor-callee-expression/index.html">KtConstructorCalleeExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getshortname"><span class="nf">getShortName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
Returns the short (unqualified) name of the annotation class, or `#!java null` if it cannot be determined.
...
Returns the type reference naming the annotation class, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getusesitetarget"><span class="nf">getUseSiteTarget</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-annotation-use-site-target/index.html">KtAnnotationUseSiteTarget</a>
</span></code></pre></div>
</div>
...
Returns the use-site target of this annotation (`#!java @get:`, `#!java @field:`, and so on), taken from the entry itself or inherited from an enclosing [`KtAnnotation`](../-kt-annotation/index.md) group, or `#!java null` if there is none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvalueargumentlist"><span class="nf">getValueArgumentList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-value-argument-list/index.html">KtValueArgumentList</a>
</span></code></pre></div>
</div>
