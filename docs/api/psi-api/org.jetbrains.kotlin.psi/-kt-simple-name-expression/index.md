...
<span class="kd">interface </span><a href="index.html">KtSimpleNameExpression</a> : <a href="../-kt-reference-expression/index.html">KtReferenceExpression</a>
</span></code></pre></div>Represents a simple name reference: an unqualified reference to a declaration by its name, or an operation sign that references a declaration (for example, the `+` of a binary expression).
...
#### See also
 ...
 - [`KtNameReferenceExpression`](../-kt-name-reference-expression/index.md): a plain identifier reference


 - [`KtOperationReferenceExpression`](../-kt-operation-reference-expression/index.md): an operation sign that references a declaration
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><span class="o"><</span><a href="index.html#accept">R</a><span class="p">, </span><a href="index.html#accept">D</a><span class="o">> </span><a href="index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><a href="../-kt-visitor/index.html">KtVisitor</a><span class="o"><</span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-reference-expression/accept.html">R</a><span class="p">, </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-reference-expression/accept.html">D</a><span class="o">></span><span class="p">, </span>data<span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-reference-expression/accept.html">D</a><span class="p">)</span><span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-reference-expression/accept.html">R</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getidentifier"><span class="nf">getIdentifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement<span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getreferencednameasname"><span class="nf">getReferencedNameAsName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-simple-name-expression-impl/index.html#getreferencednameelement"><span class="nf">getReferencedNameElement</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getreferencednameelementtype"><span class="nf">getReferencedNameElementType</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>IElementType
</span></code></pre></div>
</div>
