...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtTypeProjection</a> : <a href="../-kt-modifier-list-owner-stub/index.html">KtModifierListOwnerStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-type-projection-stub/index.html">KotlinTypeProjectionStub</a><span class="o">> </span>
</span></code></pre></div>Represents a type projection in a type argument, including variance modifiers or star projection. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-type-projection-stub/index.html">KotlinTypeProjectionStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtTypeProjection</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getprojectionkind"><span class="nf">getProjectionKind</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-projection-kind/index.html">KtProjectionKind</a>
</span></code></pre></div>
</div>
...
Returns the variance projection of this type argument: [`IN`](../-kt-projection-kind/-i-n/index.md), [`OUT`](../-kt-projection-kind/-o-u-t/index.md), [`STAR`](../-kt-projection-kind/-s-t-a-r/index.md), or [`NONE`](../-kt-projection-kind/-n-o-n-e/index.md) for an invariant argument.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getprojectiontoken"><span class="nf">getProjectionToken</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the projection token (`#!java *`, `#!java in`, or `#!java out`), or `#!java null` for an invariant argument.
...
Returns the projected type reference, or `#!java null` for a star projection (`#!java *`) or when it is absent in incomplete code.
