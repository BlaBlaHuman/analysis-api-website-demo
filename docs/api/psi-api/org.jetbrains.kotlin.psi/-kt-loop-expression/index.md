...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtLoopExpression</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>, <a href="../-kt-statement-expression/index.html">KtStatementExpression</a>
</span></code></pre></div>Represents a loop expression: a `#!java for`, `#!java while`, or `#!java do`-`#!java while` loop. 

This is the common base for the concrete node types [`KtForExpression`](../-kt-for-expression/index.md), [`KtWhileExpression`](../-kt-while-expression/index.md), and [`KtDoWhileExpression`](../-kt-do-while-expression/index.md). It gives access to the loop body shared by all loop kinds.
