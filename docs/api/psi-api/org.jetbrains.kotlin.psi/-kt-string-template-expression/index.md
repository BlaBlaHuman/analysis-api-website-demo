...
tags:
 - jvm
title: "KtStringTemplateExpression"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtStringTemplateExpression</a> : <a href="../-kt-expression-impl-stub/index.html">KtExpressionImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtStringTemplateExpression</a><span class="o">></span><span class="o">> </span>, PsiLanguageInjectionHost, ContributedReferenceHost
</span></code></pre></div>Represents a string literal, including simple strings and string templates with interpolation. 
...
### [`plainContent`](../../org.jetbrains.kotlin.psi.psiUtil/plain-content.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html">KtStringTemplateExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/plain-content.html">plainContent</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#createliteraltextescaper"><span class="nf">createLiteralTextEscaper</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>LiteralTextEscaper<span class="o"><</span><span class="kd">out </span>PsiLanguageInjectionHost<span class="o">></span>
</span></code></pre></div>
</div>
...
### [`getContentRange`](../../org.jetbrains.kotlin.psi.psiUtil/get-content-range.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtStringTemplateExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/get-content-range.html"><span class="nf">getContentRange</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>TextRange
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getentries"><span class="nf">getEntries</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="../-kt-string-template-entry/index.html">KtStringTemplateEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the segments that make up this string: literal text, escape sequences, and interpolated expressions, in source order. Empty for an empty string `#!java ""`.
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getinterpolationprefix"><span class="nf">getInterpolationPrefix</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-string-interpolation-prefix/index.html">KtStringInterpolationPrefix</a>
</span></code></pre></div>
</div>
...
The interpolation prefix if it is defined
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#hasinterpolation"><span class="nf">hasInterpolation</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this string contains at least one interpolated expression (`#!java $name` or `#!java ${...}`), as opposed to a plain string literal.
...
### [`isPlain`](../../org.jetbrains.kotlin.psi.psiUtil/is-plain.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtStringTemplateExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/is-plain.html"><span class="nf">isPlain</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
### [`isPlainWithEscapes`](../../org.jetbrains.kotlin.psi.psiUtil/is-plain-with-escapes.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtStringTemplateExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/is-plain-with-escapes.html"><span class="nf">isPlainWithEscapes</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
### [`isSingleQuoted`](../../org.jetbrains.kotlin.psi.psiUtil/is-single-quoted.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtStringTemplateExpression</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/is-single-quoted.html"><span class="nf">isSingleQuoted</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#updatetext"><span class="nf">updateText</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> text<span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a><span class="p">)</span><span class="o">: </span>PsiLanguageInjectionHost
</span></code></pre></div>
</div>
