...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtWhileExpressionBase</a> : <a href="../-kt-loop-expression/index.html">KtLoopExpression</a>
</span></code></pre></div>Represents a condition-driven loop: a `#!java while` or `#!java do`-`#!java while` loop. 

This is the common base for the concrete node types [`KtWhileExpression`](../-kt-while-expression/index.md) and [`KtDoWhileExpression`](../-kt-do-while-expression/index.md), adding access to the loop condition on top of [`KtLoopExpression`](../-kt-loop-expression/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-do-while-expression/index.html#getcondition"><span class="nf">getCondition</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the loop condition, or `#!java null` if it is absent in incomplete code.
