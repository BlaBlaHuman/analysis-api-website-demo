...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtForExpression</a> : <a href="../-kt-loop-expression/index.html">KtLoopExpression</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents a `#!java for` loop. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-do-while-expression/index.html#getbody"><span class="nf">getBody</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the loop body, or `#!java null` if it is absent in incomplete code. The body may be a [`KtBlockExpression`](../-kt-block-expression/index.md) or a single statement.
...
Returns the destructuring declaration if the loop variable destructures each element (as in `#!java for ((key, value) in map)`), or `#!java null` otherwise.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getforkeyword"><span class="nf">getForKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getinkeyword"><span class="nf">getInKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the `#!java in` keyword, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-do-while-expression/index.html#getleftparenthesis"><span class="nf">getLeftParenthesis</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the opening parenthesis of the loop header, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getloopparameter"><span class="nf">getLoopParameter</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-parameter/index.html">KtParameter</a>
</span></code></pre></div>
</div>
...
Returns the loop variable declaration (the part before `#!java in`), or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getlooprange"><span class="nf">getLoopRange</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the expression being iterated over (the part after `#!java in`), or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-do-while-expression/index.html#getrightparenthesis"><span class="nf">getRightParenthesis</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the closing parenthesis of the loop header, or `#!java null` if it is absent in incomplete code.
