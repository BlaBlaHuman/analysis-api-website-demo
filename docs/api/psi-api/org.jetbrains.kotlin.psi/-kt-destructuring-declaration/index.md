...
tags:
 - jvm
title: "KtDestructuringDeclaration"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtDestructuringDeclaration</a> : <a href="../-kt-declaration-stub/index.html">KtDeclarationStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-destructuring-declaration-stub/index.html">KotlinDestructuringDeclarationStub</a><span class="o">> </span>, <a href="../-kt-val-var-keyword-owner/index.html">KtValVarKeywordOwner</a>, <a href="../-kt-declaration-with-initializer/index.html">KtDeclarationWithInitializer</a>, <a href="../-kt-declaration-with-return-type/index.html">KtDeclarationWithReturnType</a>
</span></code></pre></div>Represents a destructuring declaration that unpacks an object into multiple variables. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-destructuring-declaration-stub/index.html">KotlinDestructuringDeclarationStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getentries"><span class="nf">getEntries</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-destructuring-declaration-entry/index.html">KtDestructuringDeclarationEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the individual component entries of this destructuring declaration (for example, `#!java x` and `#!java y` in `#!java val (x, y) = ...`), in source order.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getlpar"><span class="nf">getLPar</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the opening parenthesis or bracket, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getrpar"><span class="nf">getRPar</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the closing parenthesis or bracket, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettrailingcomma"><span class="nf">getTrailingComma</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the trailing comma after the last entry, or `#!java null` if there is none.
...
Always `#!java null`: a destructuring declaration has no type reference of its own.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#hassquarebrackets"><span class="nf">hasSquareBrackets</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
true when this destructuring declaration uses square brackets.
...
true when this destructuring declaration uses the full form with the val or var keywords inside the entries. See [KEEP](https://kotl.in/name-based-destructuring).
...
Returns `#!java true` if this destructuring declaration is mutable (introduced by `#!java var`), or `#!java false` if it is read-only (`#!java val`).
