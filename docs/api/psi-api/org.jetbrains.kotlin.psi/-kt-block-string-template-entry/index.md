...
tags:
 - jvm
title: "KtBlockStringTemplateEntry"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtBlockStringTemplateEntry</a> : <a href="../-kt-string-template-entry-with-expression/index.html">KtStringTemplateEntryWithExpression</a>
</span></code></pre></div>Represents a block interpolation in a string template using `#!java ${expression}`. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-block-string-template-entry-stub/index.html">KotlinBlockStringTemplateEntryStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Returns a list of expressions from this entry. 
 ...
 The list size is 1 for valid code, so [`getExpression`](index.md#getexpression) should be preferred and this method should be used only to process potentially error code.
...
**See also**
 ...
 - [`getExpression`](index.md#getexpression)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#gettext"><span class="nf">getText</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
