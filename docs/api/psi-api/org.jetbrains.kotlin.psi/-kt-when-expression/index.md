...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhenExpression</a> : <a href="../-kt-expression-impl/index.html">KtExpressionImpl</a>
</span></code></pre></div>Represents a `#!java when` expression with an optional subject and multiple branches. 
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getclosebrace"><span class="nf">getCloseBrace</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the closing brace of the `#!java when` block, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getelseexpression"><span class="nf">getElseExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the expression of the `#!java else` branch, or `#!java null` if this `#!java when` has no `#!java else` branch.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getentries"><span class="nf">getEntries</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-when-entry/index.html">KtWhenEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the branches of this `#!java when`, in source order; empty if there are none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getleftparenthesis"><span class="nf">getLeftParenthesis</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the opening parenthesis around the subject, or `#!java null` for a subjectless `#!java when`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getopenbrace"><span class="nf">getOpenBrace</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the opening brace of the `#!java when` block, or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getrightparenthesis"><span class="nf">getRightParenthesis</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the closing parenthesis around the subject, or `#!java null` for a subjectless `#!java when`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getsubjectexpression"><span class="nf">getSubjectExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the subject of this `#!java when`: either the entire subject variable declaration (as in `#!java when (val x = f())`) or the subject expression. Returns `#!java null` for a subjectless `#!java when`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getsubjectvariable"><span class="nf">getSubjectVariable</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-property/index.html">KtProperty</a>
</span></code></pre></div>
</div>
...
Returns the subject variable declared in the `#!java when` header (as in `#!java when (val x = f())`), or `#!java null` if the subject is a plain expression or absent.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getwhenkeyword"><span class="nf">getWhenKeyword</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
