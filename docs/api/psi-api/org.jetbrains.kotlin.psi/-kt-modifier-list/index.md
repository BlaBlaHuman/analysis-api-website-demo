...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtModifierList</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-modifier-list-stub/index.html">KotlinModifierListStub</a><span class="o">> </span>, <a href="../-kt-annotations-container/index.html">KtAnnotationsContainer</a>
</span></code></pre></div>Represents the list of modifiers and annotations that precede a declaration or other [`KtModifierListOwner`](../-kt-modifier-list-owner/index.md). 

A modifier list groups plain modifier keywords (such as `#!java public`, `#!java inline`, `#!java suspend`), annotation entries, and the `#!java context(...)` parameter list. Whether a specific modifier is present can be tested with [`hasModifier`](../-kt-declaration-modifier-list/index.md#hasmodifier). 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-modifier-list-stub/index.html">KotlinModifierListStub</a><span class="p">, </span><span class="se">@</span><span class="se">NotNull</span> nodeType<span class="o">: </span>IElementType<span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-kt-declaration-modifier-list/index.html#accept">R</a><span class="p">, </span><a href="../-kt-declaration-modifier-list/index.html#accept">D</a><span class="o">> </span><a href="../-kt-declaration-modifier-list/index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><a href="../-kt-visitor/index.html">KtVisitor</a><span class="o"><</span><a href="../-kt-declaration-modifier-list/index.html#accept">R</a><span class="p">, </span><a href="../-kt-declaration-modifier-list/index.html#accept">D</a><span class="o">></span><span class="p">, </span>data<span class="o">: </span><a href="../-kt-declaration-modifier-list/index.html#accept">D</a><span class="p">)</span><span class="o">: </span><a href="../-kt-declaration-modifier-list/index.html#accept">R</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#deletechildinternal"><span class="nf">deleteChildInternal</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> child<span class="o">: </span>ASTNode<span class="p">)</span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getannotationentries"><span class="nf">getAnnotationEntries</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-annotation-entry/index.html">KtAnnotationEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`getAnnotationEntries`](../-kt-annotations-container/index.md#getannotationentries)
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getcontextparameterlist"><span class="nf">getContextParameterList</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-context-parameter-list/index.html">KtContextParameterList</a>
</span></code></pre></div>
</div>
...
the context parameter list, or `#!java null` if this modifier list has no context parameters
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getcontextparameterlists"><span class="nf">getContextParameterLists</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/util/List.html">List</a><span class="o"><</span><a href="../-kt-context-parameter-list/index.html">KtContextParameterList</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the list of all [`KtContextParameterList`](../-kt-context-parameter-list/index.md) declared in this modifier list. 

 This method is intended only for handling error cases since valid code cannot have more than one context parameter list. 

 Prefer [`getContextParameterList`](../-kt-declaration-modifier-list/index.md#getcontextparameterlist) where it is possible.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getmodifier"><span class="nf">getModifier</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> tokenType<span class="o">: </span><a href="../../org.jetbrains.kotlin.lexer/-kt-modifier-keyword-token/index.html">KtModifierKeywordToken</a><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the token for the given modifier keyword, or `#!java null` if this modifier list does not contain it.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getmodifier"><span class="nf">getModifier</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> tokenTypes<span class="o">: </span>TokenSet<span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the first token whose type is in the given set, or `#!java null` if none is present.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#getowner"><span class="nf">getOwner</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
Returns the element that owns this modifier list (the declaration or other [`KtModifierListOwner`](../-kt-modifier-list-owner/index.md) it belongs to).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/has-actual-modifier.html"><span class="nf">hasActualModifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
### [`hasFunModifier`](../../org.jetbrains.kotlin.psi.psiUtil/has-fun-modifier.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/has-fun-modifier.html"><span class="nf">hasFunModifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-declaration-modifier-list/index.html#hasmodifier"><span class="nf">hasModifier</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> tokenType<span class="o">: </span><a href="../../org.jetbrains.kotlin.lexer/-kt-modifier-keyword-token/index.html">KtModifierKeywordToken</a><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Returns `#!java true` if this modifier list contains the given modifier keyword.


</div>

</div>
### [`hasSuspendModifier`](../../org.jetbrains.kotlin.psi.psiUtil/has-suspend-modifier.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/has-suspend-modifier.html"><span class="nf">hasSuspendModifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
### [`hasValueModifier`](../../org.jetbrains.kotlin.psi.psiUtil/has-value-modifier.md)

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/has-value-modifier.html"><span class="nf">hasValueModifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/visibility-modifier.html"><span class="nf">visibilityModifier</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement<span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KtModifierList</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.psi.psiUtil/visibility-modifier-type.html"><span class="nf">visibilityModifierType</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.lexer/-kt-modifier-keyword-token/index.html">KtModifierKeywordToken</a><span class="o">?</span>
</span></code></pre></div>
</div>
