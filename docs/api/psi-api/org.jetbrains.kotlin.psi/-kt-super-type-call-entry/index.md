...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtSuperTypeCallEntry</a> : <a href="../-kt-super-type-list-entry/index.html">KtSuperTypeListEntry</a>, <a href="../-kt-call-element/index.html">KtCallElement</a>
</span></code></pre></div>Represents a superclass constructor call in the super type list. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">var </span><a href="../-kt-super-type-list-entry/index.html#array_factory">ARRAY_FACTORY</a><span class="o">: </span>ArrayFactory<span class="o"><</span><a href="../-kt-super-type-list-entry/index.html">KtSuperTypeListEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
A factory for creating arrays of [`KtSuperTypeListEntry`](../-kt-super-type-list-entry/index.md), used by the PSI child-access machinery.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-kt-super-type-list-entry/index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="../-kt-super-type-list-entry/index.html">KtSuperTypeListEntry</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getcalleeexpression"><span class="nf">getCalleeExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-constructor-callee-expression/index.html">KtConstructorCalleeExpression</a>
</span></code></pre></div>
</div>
...
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-super-type-list-entry/index.html#gettypeasusertype"><span class="nf">getTypeAsUserType</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-user-type/index.html">KtUserType</a>
</span></code></pre></div>
</div>
...
Returns the supertype as a [`KtUserType`](../-kt-user-type/index.md), or `#!java null` if the type reference is absent or is not a user type (for example, a function type).
...
Returns the type reference of the supertype named by this entry, or `#!java null` if it is absent in incomplete code.
