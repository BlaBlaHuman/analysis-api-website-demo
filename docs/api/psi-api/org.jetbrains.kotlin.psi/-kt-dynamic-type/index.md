...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtDynamicType</a> : <a href="../-kt-element-impl-stub/index.html">KtElementImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><a href="index.html">KtDynamicType</a><span class="o">></span><span class="o">> </span>, <a href="../-kt-type-element/index.html">KtTypeElement</a>
</span></code></pre></div>Represents the `#!java dynamic` type used in Kotlin/JS for interoperability. 
...
Always empty: the `#!java dynamic` type has no type arguments.
