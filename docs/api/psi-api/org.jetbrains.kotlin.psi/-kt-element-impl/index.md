...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtElementImpl</a> : ASTWrapperPsiElement, <a href="../-kt-element/index.html">KtElement</a>
</span></code></pre></div>Base implementation of [`KtElement`](../-kt-element/index.md) backed directly by the AST tree. 

This is an internal implementation base class of the Kotlin PSI, shared by element types that are never represented by a stub. It is not intended to be used or subclassed outside of the PSI implementation. For elements that may also be backed by a stub, see [`KtElementImplStub`](../-kt-element-impl-stub/index.md).
...
#### Inheritors
 ...
 - [`KDocLink`](../../org.jetbrains.kotlin.kdoc.psi.impl/-k-doc-link/index.md)
