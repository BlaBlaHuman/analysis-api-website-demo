...
tags:
 - jvm
title: "KtErrorSafeQualifiedExpression"
---

# KtErrorSafeQualifiedExpression
...
<span class="kd">interface </span><a href="index.html">KtErrorSafeQualifiedExpression</a> : <a href="../-kt-qualified-expression/index.html">KtQualifiedExpression</a>
</span></code></pre></div>Represents an error-safe-call expression using the `|.` operator.
