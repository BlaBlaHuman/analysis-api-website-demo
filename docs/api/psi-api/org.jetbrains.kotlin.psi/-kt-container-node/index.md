...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtContainerNode</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>
</span></code></pre></div>Represents an auxiliary container node that wraps other PSI elements without adding semantic meaning. Used internally by the parser to group related elements in the syntax tree. 
