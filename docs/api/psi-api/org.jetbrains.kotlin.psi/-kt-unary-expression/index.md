...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtUnaryExpression</a> : <a href="../-kt-expression-impl-stub/index.html">KtExpressionImplStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-place-holder-stub/index.html">KotlinPlaceHolderStub</a><span class="o"><</span><span class="kd">out </span><a href="index.html">KtUnaryExpression</a><span class="o">></span><span class="o">> </span>, <a href="../-kt-operation-expression/index.html">KtOperationExpression</a>, <a href="../../org.jetbrains.kotlin.resolution/-kt-resolvable-call/index.html">KtResolvableCall</a>
</span></code></pre></div>Represents a unary expression with an operator and a single operand. 

This is the base class for:

 - [`KtPrefixExpression`](../-kt-prefix-expression/index.md) — operator before the operand (e.g., `#!java -x`)
 - [`KtPostfixExpression`](../-kt-postfix-expression/index.md) — operator after the operand (e.g., `#!java x++`)
### Example:
```java
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><span class="o"><</span><a href="../-kt-expression-impl-stub/index.html#accept">R</a><span class="p">, </span><a href="../-kt-expression-impl-stub/index.html#accept">D</a><span class="o">> </span><a href="../-kt-expression-impl-stub/index.html#accept"><span class="nf">accept</span></a><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> visitor<span class="o">: </span><a href="../-kt-visitor/index.html">KtVisitor</a><span class="o"><</span><a href="../-kt-expression-impl-stub/index.html#accept">R</a><span class="p">, </span><a href="../-kt-expression-impl-stub/index.html#accept">D</a><span class="o">></span><span class="p">, </span>data<span class="o">: </span><a href="../-kt-expression-impl-stub/index.html#accept">D</a><span class="p">)</span><span class="o">: </span><a href="../-kt-expression-impl-stub/index.html#accept">R</a>
</span></code></pre></div>
</div>
...
<span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#getbaseexpression"><span class="nf">getBaseExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="../-kt-prefix-expression/index.html#getoperationreference"><span class="nf">getOperationReference</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-operation-reference-expression/index.html">KtOperationReferenceExpression</a>
</span></code></pre></div>
</div>
