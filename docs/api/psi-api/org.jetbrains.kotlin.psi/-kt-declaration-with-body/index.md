...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KtDeclarationWithBody</a> : <a href="../-kt-declaration/index.html">KtDeclaration</a>
</span></code></pre></div>Represents a declaration that can have a body, such as a function, a property accessor, or an anonymous initializer. 

A body comes in two forms: a block body enclosed in braces, or an expression body introduced by `#!java =`. Both are returned by [`getBodyExpression`](../-kt-function/index.md#getbodyexpression); use [`hasBlockBody`](../-kt-function-not-stubbed/index.md#hasblockbody) to distinguish them. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-function/index.html#getbodyexpression"><span class="nf">getBodyExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#getequalstoken"><span class="nf">getEqualsToken</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiElement
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-function/index.html#getname"><span class="nf">getName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-function-not-stubbed/index.html#hasblockbody"><span class="nf">hasBlockBody</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-kt-function/index.html#hasdeclaredreturntype"><span class="nf">hasDeclaredReturnType</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
