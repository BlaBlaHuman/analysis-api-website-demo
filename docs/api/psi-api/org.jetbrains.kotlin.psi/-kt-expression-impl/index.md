...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtExpressionImpl</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>, <a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>Base implementation of [`KtExpression`](../-kt-expression/index.md) backed directly by the AST tree.

This is an internal implementation base class of the Kotlin PSI, not intended for direct use or subclassing outside of the PSI implementation. For expressions that may also be backed by a stub, see [`KtExpressionImplStub`](../-kt-expression-impl-stub/index.md).
