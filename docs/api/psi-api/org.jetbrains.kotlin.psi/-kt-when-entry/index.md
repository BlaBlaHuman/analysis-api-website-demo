...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhenEntry</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>
</span></code></pre></div>Represents a single branch in a `#!java when` expression. 
...
Returns the `#!java ->` arrow separating the conditions from the body, or `#!java null` if it is absent in incomplete code.
...
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getconditions"><span class="nf">getConditions</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="../-kt-when-condition/index.html">KtWhenCondition</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns the comma-separated conditions of this branch in source order. The array is empty for an `#!java else` branch and contains one or more elements for any other branch.
...
Returns the `#!java else` keyword if this is the `#!java else` branch, or `#!java null` otherwise.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getexpression"><span class="nf">getExpression</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-expression/index.html">KtExpression</a>
</span></code></pre></div>
</div>
...
Returns the body expression of this branch (the part after `#!java ->`), or `#!java null` if it is absent in incomplete code.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getguard"><span class="nf">getGuard</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-when-entry-guard/index.html">KtWhenEntryGuard</a>
</span></code></pre></div>
</div>
...
Returns the guard clause of this branch (the `#!java if` guard after the conditions), or `#!java null` if the branch has no guard.
...
Returns the trailing comma after the last condition, or `#!java null` if there is none.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#iselse"><span class="nf">isElse</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
`#!java true` if this is an `#!java else` condition with no [`guard`](index.md#getguard), `#!java false` otherwise.
