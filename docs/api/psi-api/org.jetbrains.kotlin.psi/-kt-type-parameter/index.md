...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtTypeParameter</a> : <a href="../-kt-named-declaration-stub/index.html">KtNamedDeclarationStub</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-type-parameter-stub/index.html">KotlinTypeParameterStub</a><span class="o">> </span>
</span></code></pre></div>Represents a type parameter in a generic declaration. 
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span><span class="se">@</span><span class="se">NotNull</span> stub<span class="o">: </span><a href="../../org.jetbrains.kotlin.psi.stubs/-kotlin-type-parameter-stub/index.html">KotlinTypeParameterStub</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#empty_array">EMPTY_ARRAY</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KtTypeParameter</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">Nullable</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getextendsbound"><span class="nf">getExtendsBound</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../-kt-type-reference/index.html">KtTypeReference</a>
</span></code></pre></div>
</div>
...
Returns the inline upper bound written after `#!java :` (as in `#!java <T : Comparable<T>>`), or `#!java null` if this type parameter has no inline bound. Bounds declared in a `#!java where` clause are exposed via [`getTypeConstraints`](../-kt-type-parameter-list-owner/index.md#gettypeconstraints) instead.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><span class="se">NotNull</span>
<span class="kd">open </span><span class="kd">fun </span><a href="index.html#getvariance"><span class="nf">getVariance</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>Variance
</span></code></pre></div>
</div>
...
Returns the declaration-site variance of this type parameter: OUT_VARIANCE for `#!java out`, IN_VARIANCE for `#!java in`, or INVARIANT if no variance modifier is present.
