...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtSuperTypeEntry</a> : <a href="../-kt-super-type-list-entry/index.html">KtSuperTypeListEntry</a>
</span></code></pre></div>Represents an interface type in the super type list (without a constructor call). 
