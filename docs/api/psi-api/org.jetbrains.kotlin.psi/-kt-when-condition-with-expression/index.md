...
tags:
 - jvm
title: "KtWhenConditionWithExpression"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtWhenConditionWithExpression</a> : <a href="../-kt-when-condition/index.html">KtWhenCondition</a>
</span></code></pre></div>Represents a `#!java when` condition that matches against an expression value. 
...
Returns the expression that the `#!java when` subject is compared against, or `#!java null` if it is absent in incomplete code.
