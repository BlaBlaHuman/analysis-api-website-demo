...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KtWhenCondition</a> : <a href="../-kt-element-impl/index.html">KtElementImpl</a>
</span></code></pre></div>Represents a single condition of a [`KtWhenEntry`](../-kt-when-entry/index.md) in a `#!java when` expression. 

This is the common base for the concrete node types [`KtWhenConditionWithExpression`](../-kt-when-condition-with-expression/index.md) (a plain or equality check), [`KtWhenConditionInRange`](../-kt-when-condition-in-range/index.md) (an `#!java in`/`#!java !in` check), and [`KtWhenConditionIsPattern`](../-kt-when-condition-is-pattern/index.md) (an `#!java is`/`#!java !is` check). A single entry may list several comma-separated conditions. 
