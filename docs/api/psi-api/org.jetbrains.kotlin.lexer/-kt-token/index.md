...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtToken</a> : IElementType
</span></code></pre></div>#### Inheritors


 - [`KtSingleValueToken`](../-kt-single-value-token/index.md)
 - [`KDocToken`](../../org.jetbrains.kotlin.kdoc.lexer/-k-doc-token/index.md)
