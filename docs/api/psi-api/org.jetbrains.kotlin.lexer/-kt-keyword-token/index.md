...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">class </span><a href="index.html">KtKeywordToken</a> : <a href="../-kt-single-value-token/index.html">KtSingleValueToken</a>
</span></code></pre></div>#### Inheritors


 - [`KtModifierKeywordToken`](../-kt-modifier-keyword-token/index.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-modifier-keyword-token/index.html#keyword"><span class="nf">keyword</span></a><span class="p">(</span>value<span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a><span class="p">, </span>tokenId<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a><span class="p">)</span><span class="o">: </span><a href="index.html">KtKeywordToken</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-modifier-keyword-token/index.html#keyword"><span class="nf">keyword</span></a><span class="p">(</span>
...
<span class="p">)</span><span class="o">: </span><a href="index.html">KtKeywordToken</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-modifier-keyword-token/index.html#softkeyword"><span class="nf">softKeyword</span></a><span class="p">(</span>value<span class="o">: </span><a href="https://docs.oracle.com/javase/8/docs/api/java/lang/String.html">String</a><span class="p">, </span>tokenId<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a><span class="p">)</span><span class="o">: </span><a href="index.html">KtKeywordToken</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="../-kt-modifier-keyword-token/index.html#issoft"><span class="nf">isSoft</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
