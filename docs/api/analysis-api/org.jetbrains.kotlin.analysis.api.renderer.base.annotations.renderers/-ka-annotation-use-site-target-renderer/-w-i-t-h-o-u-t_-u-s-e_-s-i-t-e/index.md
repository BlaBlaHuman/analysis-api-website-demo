...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="index.html">WITHOUT_USE_SITE</a> : <a href="../index.html">KaAnnotationUseSiteTargetRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#renderusesitetarget"><span class="nf">renderUseSiteTarget</span></a><span class="p">(</span>
