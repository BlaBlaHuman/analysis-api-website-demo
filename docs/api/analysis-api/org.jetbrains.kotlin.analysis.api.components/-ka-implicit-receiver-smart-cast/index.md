...
</span></code></pre></div><strong>The type has been moved to a new package. Use </strong>[`<strong>org.jetbrains.kotlin.analysis.api.dataflow.KaImplicitReceiverSmartCast</strong>`](../../org.jetbrains.kotlin.analysis.api.dataflow/-ka-implicit-receiver-smart-cast/index.md)<strong> instead.</strong>
