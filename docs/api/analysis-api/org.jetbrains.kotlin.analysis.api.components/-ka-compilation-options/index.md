...
<span class="kd">interface </span><a href="index.html">KaCompilationOptions</a> : <a href="../../org.jetbrains.kotlin.analysis.api.compilation/-ka-compilation-options/index.html">KaCompilationOptions</a>
</span></code></pre></div><strong>The type has been moved to a new package. Use </strong>[`<strong>org.jetbrains.kotlin.analysis.api.compilation.KaCompilationOptions</strong>`](../../org.jetbrains.kotlin.analysis.api.compilation/-ka-compilation-options/index.md)<strong> instead.</strong>

An immutable set of options for in-memory compilation via [`KaCompilerFacility`](../-ka-compiler-facility/index.md).

Use [`KaCompilerFacility.createCompilationOptions`](../-ka-compiler-facility/index.md#createcompilationoptions) to create an instance, and [`KaCompilerFacility.modify`](../-ka-compiler-facility/index.md#modify) to produce a modified copy.
...
Creates a copy of these [`KaCompilationOptions`](../../org.jetbrains.kotlin.analysis.api.compilation/-ka-compilation-options/index.md), applying the given [`init`](index.md#modify) modifications.
