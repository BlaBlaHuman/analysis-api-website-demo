...
<span class="kd">interface </span><a href="index.html">KaArrayTypeBuilder</a> : <a href="../-ka-type-builder/index.html">KaTypeBuilder</a>
</span></code></pre></div>A builder for array types.

#### See also


 - [`KaTypeCreator.buildTypeParameterType`](../-ka-type-creator/index.md#buildtypeparametertype)
...
**See also**
 ...
 - [`KaTypeInformationProvider.isMarkedNullable`](../-ka-type-information-provider/index.md#ismarkednullable)
