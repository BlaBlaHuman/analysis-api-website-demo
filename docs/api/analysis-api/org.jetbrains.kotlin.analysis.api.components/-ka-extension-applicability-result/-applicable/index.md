...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">class </span><a href="index.html">Applicable</a> : <a href="../index.html">KaExtensionApplicabilityResult</a>
</span></code></pre></div>#### Inheritors


 - [`ApplicableAsExtensionCallable`](../-applicable-as-extension-callable/index.md)
 - [`ApplicableAsFunctionalVariableCall`](../-applicable-as-functional-variable-call/index.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#receivercastrequired">receiverCastRequired</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#substitutor">substitutor</a><span class="o">: </span><a href="../../../org.jetbrains.kotlin.analysis.api.types/-ka-substitutor/index.html">KaSubstitutor</a>
</span></code></pre></div>
</div>
