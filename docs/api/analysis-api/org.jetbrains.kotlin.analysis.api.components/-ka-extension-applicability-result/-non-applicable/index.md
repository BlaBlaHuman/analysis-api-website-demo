...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">NonApplicable</a><span class="p">(</span><span class="kd">val </span>token<span class="o">: </span><a href="../../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-token/index.html">KaLifetimeToken</a><span class="p">)</span> : <a href="../index.html">KaExtensionApplicabilityResult</a>
</span></code></pre></div>
</div>
