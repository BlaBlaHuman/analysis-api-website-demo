...
tags:
 - jvm
title: "KaExtensionApplicabilityResult"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">class </span><a href="index.html">KaExtensionApplicabilityResult</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>Represents the result of checking the applicability of an extension callable in a specific context.

#### Inheritors


 - [`Applicable`](-applicable/index.md)
 - [`NonApplicable`](-non-applicable/index.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">class </span><a href="-applicable/index.html">Applicable</a> : <a href="index.html">KaExtensionApplicabilityResult</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="-applicable-as-extension-callable/index.html">ApplicableAsExtensionCallable</a><span class="p">(</span>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="-applicable-as-functional-variable-call/index.html">ApplicableAsFunctionalVariableCall</a><span class="p">(</span>
    substitutor<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-substitutor/index.html">KaSubstitutor</a><span class="p">, </span>
    receiverCastRequired<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a><span class="p">, </span>
    <span class="kd">val </span>token<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-token/index.html">KaLifetimeToken</a>
<span class="p">)</span> : <a href="-applicable/index.html">KaExtensionApplicabilityResult.Applicable</a>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="-non-applicable/index.html">NonApplicable</a><span class="p">(</span><span class="kd">val </span>token<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-token/index.html">KaLifetimeToken</a><span class="p">)</span> : <a href="index.html">KaExtensionApplicabilityResult</a>
</span></code></pre></div>
</div>
