...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">ExplicitStarImportingScope</a><span class="p">(</span><span class="kd">val </span>indexInTower<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a><span class="p">)</span> : <a href="../../-ka-scope-kind/-explicit-star-importing-scope/index.html">KaScopeKind.ExplicitStarImportingScope</a>
</span></code></pre></div>
</div>
