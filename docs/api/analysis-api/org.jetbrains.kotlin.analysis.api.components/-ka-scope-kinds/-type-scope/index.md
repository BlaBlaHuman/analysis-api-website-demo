...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">TypeScope</a><span class="p">(</span><span class="kd">val </span>indexInTower<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a><span class="p">)</span> : <a href="../../-ka-scope-kind/-type-scope/index.html">KaScopeKind.TypeScope</a>
</span></code></pre></div>
</div>
