...
<span class="kd">interface </span><a href="index.html">KaScopeWithKind</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>A wrapper around a [`KaScope`](../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) which is additionally positioned in the scope tower of a [`KaScopeContext`](../-ka-scope-context/index.md), represented by [`KaScopeKind`](../-ka-scope-kind/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#kind">kind</a><span class="o">: </span><a href="../-ka-scope-kind/index.html">KaScopeKind</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#scope">scope</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.html">KaScope</a>
</span></code></pre></div>
</div>
...
The [`KaScope`](../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) underlying this [`KaScopeWithKind`](index.md).
