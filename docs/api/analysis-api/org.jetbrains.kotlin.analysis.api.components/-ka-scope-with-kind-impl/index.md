...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">KaScopeWithKindImpl</a><span class="p">(</span>backingScope<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.html">KaScope</a><span class="p">, </span>backingKind<span class="o">: </span><a href="../-ka-scope-kind/index.html">KaScopeKind</a><span class="p">)</span> : <a href="../-ka-scope-with-kind/index.html">KaScopeWithKind</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span>backingScope<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.html">KaScope</a><span class="p">, </span>backingKind<span class="o">: </span><a href="../-ka-scope-kind/index.html">KaScopeKind</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#kind">kind</a><span class="o">: </span><a href="../-ka-scope-kind/index.html">KaScopeKind</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#scope">scope</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.html">KaScope</a>
</span></code></pre></div>
</div>
...
The [`KaScope`](../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) underlying this [`KaScopeWithKind`](../-ka-scope-with-kind/index.md).
