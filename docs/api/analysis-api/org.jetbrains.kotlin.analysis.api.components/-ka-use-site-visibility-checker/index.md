...
<span class="kd">interface </span><a href="index.html">KaUseSiteVisibilityChecker</a> : <a href="../../org.jetbrains.kotlin.analysis.api.visibility/-ka-use-site-visibility-checker/index.html">KaUseSiteVisibilityChecker</a>
</span></code></pre></div><strong>The type has been moved to a new package. Use </strong>[`<strong>org.jetbrains.kotlin.analysis.api.visibility.KaUseSiteVisibilityChecker</strong>`](../../org.jetbrains.kotlin.analysis.api.visibility/-ka-use-site-visibility-checker/index.md)<strong> instead.</strong>
...
[`KaUseSiteVisibilityChecker`](index.md) is created by [`KaVisibilityChecker.createUseSiteVisibilityChecker`](../-ka-visibility-checker/index.md#createusesitevisibilitychecker).
