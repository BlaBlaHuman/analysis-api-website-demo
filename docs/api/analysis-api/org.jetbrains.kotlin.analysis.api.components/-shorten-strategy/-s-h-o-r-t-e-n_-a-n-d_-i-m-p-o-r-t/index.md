...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">SHORTEN_AND_IMPORT</a>
...
Example: package a.b.c fun test() {} fun runFunctions() {      foo.bar()     // -> bar() and add a new import directive `import foo.bar`      a.b.c.test()  // -> test() }
