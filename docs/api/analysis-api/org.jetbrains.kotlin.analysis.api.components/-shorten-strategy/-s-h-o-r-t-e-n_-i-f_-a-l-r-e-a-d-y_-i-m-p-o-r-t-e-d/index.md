...
tags:
 - jvm
title: "SHORTEN_IF_ALREADY_IMPORTED"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">SHORTEN_IF_ALREADY_IMPORTED</a>
...
Example: package a.b.c import foo.bar fun test() {} fun runFunctions() {      foo.bar()     // -> bar()      a.b.c.test()  // -> test() }
