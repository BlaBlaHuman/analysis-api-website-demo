...
<span class="kd">interface </span><a href="index.html">TypeScope</a> : <a href="../index.html">KaScopeKind</a>
</span></code></pre></div>Represents a [`KaScope`](../../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) for a type, which includes [synthetic Java properties](https://kotlinlang.org/docs/java-interop.html#getters-and-setters) of that type.

#### Inheritors


 - [`TypeScope`](../../-ka-scope-kinds/-type-scope/index.md)
