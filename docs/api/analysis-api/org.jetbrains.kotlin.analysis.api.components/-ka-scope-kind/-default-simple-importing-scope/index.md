...
tags:
 - jvm
title: "DefaultSimpleImportingScope"
---
...
<span class="kd">interface </span><a href="index.html">DefaultSimpleImportingScope</a> : <a href="../-importing-scope/index.html">KaScopeKind.ImportingScope</a>
</span></code></pre></div>Represents a [`KaScope`](../../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) containing declarations from non-star imports which are not declared explicitly and are added by default.

#### Inheritors


 - [`DefaultSimpleImportingScope`](../../-ka-scope-kinds/-default-simple-importing-scope/index.md)
