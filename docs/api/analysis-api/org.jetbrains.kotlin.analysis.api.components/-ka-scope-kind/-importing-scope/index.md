...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="index.html">ImportingScope</a> : <a href="../-non-local-scope/index.html">KaScopeKind.NonLocalScope</a>
</span></code></pre></div>Represents a [`KaScope`](../../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) containing declarations from imports.
