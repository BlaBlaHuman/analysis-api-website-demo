...
<span class="kd">interface </span><a href="index.html">TypeParameterScope</a> : <a href="../-non-local-scope/index.html">KaScopeKind.NonLocalScope</a>
</span></code></pre></div>Represents a [`KaScope`](../../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) containing type parameters.

#### Inheritors


 - [`TypeParameterScope`](../../-ka-scope-kinds/-type-parameter-scope/index.md)
