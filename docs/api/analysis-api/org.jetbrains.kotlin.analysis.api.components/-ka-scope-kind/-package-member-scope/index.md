...
<span class="kd">interface </span><a href="index.html">PackageMemberScope</a> : <a href="../-non-local-scope/index.html">KaScopeKind.NonLocalScope</a>
</span></code></pre></div>Represents a [`KaScope`](../../../org.jetbrains.kotlin.analysis.api.scopes/-ka-scope/index.md) containing declarations from a package.

#### Inheritors


 - [`PackageMemberScope`](../../-ka-scope-kinds/-package-member-scope/index.md)
