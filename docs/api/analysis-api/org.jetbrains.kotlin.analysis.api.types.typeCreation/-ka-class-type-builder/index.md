...
<span class="kd">interface </span><a href="index.html">KaClassTypeBuilder</a> : <a href="../-ka-type-builder-with-annotations/index.html">KaTypeBuilderWithAnnotations</a>
</span></code></pre></div>A builder for [`KaClassType`](../../org.jetbrains.kotlin.analysis.api.types/-ka-class-type/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#annotations"><span class="nf">annotations</span></a><span class="p">(</span>annotationClassIds<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-iterable/index.html">Iterable</a><span class="o"><</span>ClassId<span class="o">></span><span class="p">)</span>
</span></code></pre></div><div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#annotations"><span class="nf">annotations</span></a><span class="p">(</span>annotationClassIds<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-iterable/index.html">Iterable</a><span class="o"><</span>ClassId<span class="o">></span><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`annotationClassIds`](../-ka-function-type-builder/index.md#annotations) to [`annotations`](../-ka-function-type-builder/index.md#annotations).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#typearguments"><span class="nf">typeArguments</span></a><span class="p">(</span>arguments<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-iterable/index.html">Iterable</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type-projection/index.html">KaTypeProjection</a><span class="o">></span><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`arguments`](index.md#typearguments) as type arguments to the class type.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#typearguments">typeArguments</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type-projection/index.html">KaTypeProjection</a><span class="o">></span>
</span></code></pre></div>
</div>
...
List of type arguments that are currently registered in the builder. A type argument can be added using [`typeArgument`](index.md#typeargument), [`typeArguments`](index.md#typearguments) or [`invariantTypeArgument`](index.md#invarianttypeargument).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#annotation"><span class="nf">annotation</span></a><span class="p">(</span>annotationClassId<span class="o">: </span>ClassId<span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`annotationClassId`](../-ka-function-type-builder/index.md#annotation) to [`annotations`](../-ka-function-type-builder/index.md#annotations).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#annotation"><span class="nf">annotation</span></a><span class="p">(</span>annotationClassId<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span>ClassId<span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds the annotation produced by [`annotationClassId`](../-ka-function-type-builder/index.md#annotation) to [`annotations`](../-ka-function-type-builder/index.md#annotations).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#classtype"><span class="nf">classType</span></a><span class="p">(</span>classId<span class="o">: </span>ClassId<span class="p">, </span>init<span class="o">: </span><a href="index.html">KaClassTypeBuilder</a><span class="p">.</span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html">Unit</a><span class="o"> = </span>{}<span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#classtype"><span class="nf">classType</span></a><span class="p">(</span>symbol<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-class-like-symbol/index.html">KaClassLikeSymbol</a><span class="p">, </span>init<span class="o">: </span><a href="index.html">KaClassTypeBuilder</a><span class="p">.</span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html">Unit</a><span class="o"> = </span>{}<span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#invarianttypeargument"><span class="nf">invariantTypeArgument</span></a><span class="p">(</span>type<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div><div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#invarianttypeargument"><span class="nf">invariantTypeArgument</span></a><span class="p">(</span>type<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`type`](index.md#invarianttypeargument) as an invariant type argument to the class type.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#typeargument"><span class="nf">typeArgument</span></a><span class="p">(</span>variance<span class="o">: </span>Variance<span class="p">, </span>type<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div><div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#typeargument"><span class="nf">typeArgument</span></a><span class="p">(</span>variance<span class="o">: </span>Variance<span class="p">, </span>type<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`type`](index.md#typeargument) as a type argument to the class type with the given [`variance`](index.md#typeargument).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#typeargument"><span class="nf">typeArgument</span></a><span class="p">(</span>argument<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type-projection/index.html">KaTypeProjection</a><span class="p">)</span>
</span></code></pre></div><div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#typeargument"><span class="nf">typeArgument</span></a><span class="p">(</span>argument<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type-projection/index.html">KaTypeProjection</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds [`argument`](index.md#typeargument) as a type argument to the class type.
