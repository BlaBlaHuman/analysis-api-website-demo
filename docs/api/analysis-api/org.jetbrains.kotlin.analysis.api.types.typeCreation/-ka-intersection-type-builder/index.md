...
tags:
 - jvm
title: "KaIntersectionTypeBuilder"
---
...
<span class="kd">interface </span><a href="index.html">KaIntersectionTypeBuilder</a> : <a href="../-ka-type-builder/index.html">KaTypeBuilder</a>
</span></code></pre></div>A builder for [`KaIntersectionType`](../../org.jetbrains.kotlin.analysis.api.types/-ka-intersection-type/index.md).

#### See also


 - [`KaTypeCreator.intersectionType`](../-ka-function-type-builder/index.md#intersectiontype)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#conjuncts"><span class="nf">conjuncts</span></a><span class="p">(</span>conjuncts<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-iterable/index.html">Iterable</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="o">></span><span class="p">)</span>
</span></code></pre></div><div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#conjuncts"><span class="nf">conjuncts</span></a><span class="p">(</span>conjuncts<span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-iterable/index.html">Iterable</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="o">></span><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds a list of conjuncts to the [`conjuncts`](index.md#conjuncts) set.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#conjuncts">conjuncts</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-set/index.html">Set</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#conjunct"><span class="nf">conjunct</span></a><span class="p">(</span>conjunct<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds a [`conjunct`](index.md#conjunct) to the [`conjuncts`](index.md#conjuncts) set.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#conjunct"><span class="nf">conjunct</span></a><span class="p">(</span>conjunct<span class="o">: </span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Adds a conjunct produced by [`conjunct`](index.md#conjunct) to the [`conjuncts`](index.md#conjuncts) set.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#intersectiontype"><span class="nf">intersectionType</span></a><span class="p">(</span>init<span class="o">: </span><a href="index.html">KaIntersectionTypeBuilder</a><span class="p">.</span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html">Unit</a><span class="o"> = </span>{}<span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
Note that currently it's impossible to provide annotations in [`KaIntersectionTypeBuilder`](index.md) due to KT-80749.
