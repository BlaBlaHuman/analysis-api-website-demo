...
<span class="kd">interface </span><a href="index.html">KaTypeBuilder</a> : <a href="../-ka-type-creator/index.html">KaTypeCreator</a>
</span></code></pre></div>A base interface for all concrete type builders.

[`KaTypeBuilder`](index.md) is derived from [`KaTypeCreator`](../-ka-type-creator/index.md) to extend its type building API while keeping all base endpoints accessible.
