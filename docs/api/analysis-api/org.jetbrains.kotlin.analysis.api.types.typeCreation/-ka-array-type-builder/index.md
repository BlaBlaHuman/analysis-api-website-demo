...
<span class="kd">interface </span><a href="index.html">KaArrayTypeBuilder</a> : <a href="../-ka-type-builder-with-annotations/index.html">KaTypeBuilderWithAnnotations</a>
</span></code></pre></div>A builder for array types.

#### See also


 - [`KaTypeCreator.arrayType`](../-ka-function-type-builder/index.md#arraytype)
...
### shouldPreferPrimitiveTypes

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">var </span><a href="index.html#shouldpreferprimitivetypes">shouldPreferPrimitiveTypes</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the builder should try to construct [primitive arrays](https://kotlinlang.org/docs/arrays.html#primitive-type-arrays) (e.g. `IntArray`) for primitive types (e.g. `Int`).

Note that nullable primitive types (e.g. `Int?`) are not considered primitive, as they are represented as objects. Thus, for these types, the builder will always produce boxed arrays (e.g. `Array<Int?>`).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">var </span><a href="index.html#variance">variance</a><span class="o">: </span>Variance
</span></code></pre></div>
</div>
...
Variance that should be used for the resulting boxed array (`Array<T>`). This doesn't affect anything if [`shouldPreferPrimitiveTypes`](index.md#shouldpreferprimitivetypes) is set to `true` and the given element type is primitive.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="../-ka-function-type-builder/index.html#arraytype"><span class="nf">arrayType</span></a><span class="p">(</span>elementType<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="p">, </span>init<span class="o">: </span><a href="index.html">KaArrayTypeBuilder</a><span class="p">.</span><span class="p">(</span><span class="p">)</span><span class="o"> -> </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html">Unit</a><span class="o"> = </span>{}<span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
Builds an array type from the given [`elementType`](../-ka-function-type-builder/index.md#arraytype). For primitive element types, the [`KaArrayTypeBuilder.shouldPreferPrimitiveTypes`](index.md#shouldpreferprimitivetypes) option determines whether the array type will be a [primitive array type](https://kotlinlang.org/docs/arrays.html#primitive-type-arrays).
