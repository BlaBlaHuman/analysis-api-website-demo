...
<span class="kd">interface </span><a href="index.html">KaDiagnostic</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>A diagnostic message reported by the compiler checker.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-diagnostic-with-psi/index.html#defaultmessage">defaultMessage</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#diagnosticclass">diagnosticClass</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.reflect/-k-class/index.html">KClass</a><span class="o"><</span><span class="o">*</span><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-diagnostic-with-psi/index.html#factoryname">factoryName</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
Because `foo` is not defined, the compiler reports an `UNRESOLVED_REFERENCE` error. This would also be the [`factoryName`](../-ka-diagnostic-with-psi/index.md#factoryname) of the [`KaDiagnostic`](index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-diagnostic-with-psi/index.html#issuppressed">isSuppressed</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Suppressed diagnostics are not reported by the compiler, so they should not be presented to the user as is. By default, diagnostic collection filters them out; [`KaDiagnostics.ignoreSuppressed`](../-ka-diagnostics/index.md#ignoresuppressed) yields them as well.

The property is only meaningful for diagnostics obtained from diagnostic collection. For diagnostics obtained in another way, such as diagnostics of an unresolved call, the property is always `false`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-diagnostic-with-psi/index.html#severity">severity</a><span class="o">: </span><a href="../-ka-severity/index.html">KaSeverity</a>
</span></code></pre></div>
</div>
...
The severity of the diagnostic (e.g. [`error`](../-ka-severity/-e-r-r-o-r/index.md) or [`warning`](../-ka-severity/-w-a-r-n-i-n-g/index.md)), which is determined from the compiler's classification of the diagnostic.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html">KaDiagnostic</a><span class="p">.</span><a href="../-ka-diagnostic-with-psi/index.html#getdefaultmessagewithfactoryname"><span class="nf">getDefaultMessageWithFactoryName</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
Returns a formatted string of the diagnostic's [`factory name`](../-ka-diagnostic-with-psi/index.md#factoryname) and [`default message`](../-ka-diagnostic-with-psi/index.md#defaultmessage).
