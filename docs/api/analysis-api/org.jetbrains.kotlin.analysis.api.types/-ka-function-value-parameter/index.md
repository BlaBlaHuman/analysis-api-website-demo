...
tags:
 - jvm
title: "KaFunctionValueParameter"
---
...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaFunctionValueParameter</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>Represents a function value parameter
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#name">name</a><span class="o">: </span>Name<span class="o">?</span>
</span></code></pre></div>
</div>
...
Note that some parameters might not have names by their nature. This applies to, for example, receiver parameters in references to member functions.
...
`fooRef` from the example above has `KaFunctionType`. This type has two `KaFunctionValueParameter`s:
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#type">type</a><span class="o">: </span><a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
