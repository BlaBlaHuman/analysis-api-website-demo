...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaFlexibleType</a> : <a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>[`KaFlexibleType`](index.md) represents a [flexible type](https://kotlinlang.org/spec/type-system.html#flexible-types) (or a so-called [platform type](https://kotlinlang.org/docs/java-interop.html#null-safety-and-platform-types)), a range of types from the [`lowerBound`](index.md#lowerbound) to the [`upperBound`](index.md#upperbound) (both inclusive).

A flexible type's [`abbreviation`](../-ka-dynamic-type/index.md#abbreviation) is always `null`, as only [`lowerBound`](index.md#lowerbound) and [`upperBound`](index.md#upperbound) can actually be expanded types.
...
For flexible types, direct supertypes of both the upper and lower bounds are returned. If that's not desirable, use [`directSupertypes`](../-ka-dynamic-type/index.md#directsupertypes) on [`KaFlexibleType.upperBound`](index.md#upperbound) or [`KaFlexibleType.lowerBound`](index.md#lowerbound).
...
For flexible types, direct supertypes of both the upper and lower bounds are included. If that's not desirable, use [`directSupertypes`](../-ka-dynamic-type/index.md#directsupertypes) on [`KaFlexibleType.upperBound`](index.md#upperbound) or [`KaFlexibleType.lowerBound`](index.md#lowerbound).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#lowerbound">lowerBound</a><span class="o">: </span><a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#upperbound">upperBound</a><span class="o">: </span><a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
Returns the [`KaFlexibleType`](index.md)'s lower bound, or the type itself if it is not flexible.
...
Returns the [`KaFlexibleType`](index.md)'s upper bound, or the type itself if it is not flexible.
