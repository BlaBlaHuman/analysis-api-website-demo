...
<span class="kd">interface </span><a href="index.html">KaErrorType</a> : <a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>[`KaErrorType`](index.md) represents a type that failed to resolve correctly.

The more specific [`KaClassErrorType`](../-ka-class-error-type/index.md) has additional information available to work with.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-class-error-type/index.html#errormessage">errorMessage</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
...
Whether the [`KaType`](../-ka-type/index.md) is a [`org.jetbrains.kotlin.analysis.api.types.KaFlexibleType`](../-ka-flexible-type/index.md) / [`org.jetbrains.kotlin.analysis.api.types.KaDynamicType`](../-ka-dynamic-type/index.md) with flexible nullability or [`org.jetbrains.kotlin.analysis.api.types.KaErrorType`](index.md) with unknown nullability. Both safe and ordinary calls are valid on such types.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-class-error-type/index.html#presentabletext">presentableText</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
A [`KaTypeScope`](../../org.jetbrains.kotlin.analysis.api.scopes/-ka-type-scope/index.md) for the given [`KaType`](../-ka-type/index.md), or `null` if the type is [`erroneous`](index.md). The scope includes all members which are callable on a given type. It also includes [synthetic Java properties](https://kotlinlang.org/docs/java-interop.html#getters-and-setters).
