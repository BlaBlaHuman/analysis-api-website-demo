...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">SUPER_TYPE</a>
...
Additionally, the mode avoids converting declaration-site variance of type parameters to Java use-site wildcard types. For example, a type parameter `out T` given a use-site `List<T>` would not be converted to `List<? extends T>`.
