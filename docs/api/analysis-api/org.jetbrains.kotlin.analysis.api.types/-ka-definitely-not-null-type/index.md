...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaDefinitelyNotNullType</a> : <a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>[`KaDefinitelyNotNullType`](index.md) represents a [definitely not-null type](https://kotlinlang.org/docs/generics.html#definitely-non-nullable-types), such as `T & Any` for a type parameter `T`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#original">original</a><span class="o">: </span><a href="../-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
