...
<span class="kd">interface </span><a href="index.html">KaStarTypeProjection</a> : <a href="../-ka-type-projection/index.html">KaTypeProjection</a>
</span></code></pre></div>Represents a [star projection](https://kotlinlang.org/docs/generics.html#star-projections) (`*`) used in type arguments. It indicates that the specific type argument is not important or unknown.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#type">type</a><span class="o">: </span><a href="../-ka-type/index.html">KaType</a><span class="o">?</span>
</span></code></pre></div>
</div>
