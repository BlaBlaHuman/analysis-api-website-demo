...
<span class="kd">interface </span><a href="index.html">Empty</a> : <a href="../index.html">KaSubstitutor</a>
</span></code></pre></div>A [`KaSubstitutor`](../index.md) with an empty type mapping. It does not perform any substitution.

Can be constructed using [`emptySubstitutor`](../../empty-substitutor.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">fun </span><a href="index.html#substitute"><span class="nf">substitute</span></a><span class="p">(</span>type<span class="o">: </span><a href="../../-ka-type/index.html">KaType</a><span class="p">)</span><span class="o">: </span><a href="../../-ka-type/index.html">KaType</a>
</span></code></pre></div>
</div>
...
Substitutes the type parameters in [`type`](index.md#substitute) using the substitutor's type mapping.

**Return**

The substituted type if there was at least one substitution, or [`type`](index.md#substitute) itself otherwise.
...
Substitutes the type parameters in [`type`](index.md#substituteornull) using the substitutor's type mapping.
