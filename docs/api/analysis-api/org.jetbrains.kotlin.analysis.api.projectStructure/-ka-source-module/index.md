...
<span class="kd">interface </span><a href="index.html">KaSourceModule</a> : <a href="../-ka-module/index.html">KaModule</a>
</span></code></pre></div>A [`KaModule`](../-ka-module/index.md) representing a set of source declarations.

A [`KaSourceModule`](index.md) does not necessarily have to correspond directly to an Analysis API platform's concept of a "module." For example, the IntelliJ implementation distinguishes between production and test source sets. As such, the `src` and `test` source sets of an IntelliJ module are actually different [`KaSourceModule`](index.md)s. To allow a test source module to use the internal declarations from the production source module, the test source module defines a [`friend dependency`](../-ka-not-under-content-root-module/index.md#directfrienddependencies) on the production source module.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#languageversionsettings">languageVersionSettings</a><span class="o">: </span>LanguageVersionSettings
</span></code></pre></div>
</div>
...
In practice, the specific format of the [`name`](index.md#name) depends on the Analysis API platform which provides the [`KaSourceModule`](index.md) implementation.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">val </span><a href="index.html#psiroots">psiRoots</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span>PsiFileSystemItem<span class="o">></span>
</span></code></pre></div>
</div>
