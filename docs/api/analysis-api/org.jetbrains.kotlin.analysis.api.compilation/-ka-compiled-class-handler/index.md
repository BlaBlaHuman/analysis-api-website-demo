...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><span class="kd">interface </span><a href="index.html">KaCompiledClassHandler</a>
</span></code></pre></div>A handler which is called whenever a new class file is produced, when compiling sources to the JVM target.
...
#### Inheritors
 ...
 - [`KaCompiledClassHandler`](../../org.jetbrains.kotlin.analysis.api.components/-ka-compiled-class-handler/index.md)
