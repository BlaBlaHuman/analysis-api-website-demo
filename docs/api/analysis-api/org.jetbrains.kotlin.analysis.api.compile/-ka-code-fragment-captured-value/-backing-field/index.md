...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">BackingField</a><span class="p">(</span>
...
</span></code></pre></div>Represents a backing field (a `field` variable inside a property accessor).
