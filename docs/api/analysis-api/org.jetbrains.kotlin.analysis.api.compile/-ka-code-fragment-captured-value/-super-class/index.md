...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">SuperClass</a><span class="p">(</span>
...
</span></code></pre></div>Represents a captured super class (`super.foo()`).
