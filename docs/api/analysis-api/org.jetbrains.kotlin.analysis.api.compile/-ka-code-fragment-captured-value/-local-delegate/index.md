...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">LocalDelegate</a><span class="p">(</span>
...
</span></code></pre></div>Represents a delegated local variable (`val local by...`).
