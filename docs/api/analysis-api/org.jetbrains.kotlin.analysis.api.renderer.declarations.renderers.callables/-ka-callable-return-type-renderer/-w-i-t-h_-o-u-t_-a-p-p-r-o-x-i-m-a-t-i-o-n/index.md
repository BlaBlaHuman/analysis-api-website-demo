...
tags:
 - jvm
title: "WITH_OUT_APPROXIMATION"
---

# WITH_OUT_APPROXIMATION

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="index.html">WITH_OUT_APPROXIMATION</a> : <a href="../index.html">KaCallableReturnTypeRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#renderreturntype"><span class="nf">renderReturnType</span></a><span class="p">(</span>
