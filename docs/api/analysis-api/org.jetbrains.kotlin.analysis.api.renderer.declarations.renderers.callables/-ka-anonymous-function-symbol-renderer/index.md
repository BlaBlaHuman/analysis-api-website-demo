...
tags:
 - jvm
title: "KaAnonymousFunctionSymbolRenderer"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KaAnonymousFunctionSymbolRenderer</a>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="-a-s_-s-o-u-r-c-e/index.html">AS_SOURCE</a> : <a href="index.html">KaAnonymousFunctionSymbolRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#rendersymbol"><span class="nf">renderSymbol</span></a><span class="p">(</span>
    ...
    symbol<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-anonymous-function-symbol/index.html">KaAnonymousFunctionSymbol</a><span class="p">, </span>
