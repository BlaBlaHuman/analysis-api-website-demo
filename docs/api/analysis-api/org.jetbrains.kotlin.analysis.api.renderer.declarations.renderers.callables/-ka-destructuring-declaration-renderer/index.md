...
tags:
 - jvm
title: "KaDestructuringDeclarationRenderer"
---

# KaDestructuringDeclarationRenderer

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">interface </span><a href="index.html">KaDestructuringDeclarationRenderer</a>
</span></code></pre></div>#### Inheritors


 - [`WITH_ENTRIES`](-w-i-t-h_-e-n-t-r-i-e-s/index.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="-w-i-t-h_-e-n-t-r-i-e-s/index.html">WITH_ENTRIES</a> : <a href="index.html">KaDestructuringDeclarationRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">fun </span><a href="index.html#rendersymbol"><span class="nf">renderSymbol</span></a><span class="p">(</span>
    ...
    symbol<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-destructuring-declaration-symbol/index.html">KaDestructuringDeclarationSymbol</a><span class="p">, </span>
