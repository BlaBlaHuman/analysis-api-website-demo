...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">WITH_OUTER_CLASSIFIERS</a>

</span></code></pre></div>The name prefixed with its outer classifiers, but without the package, e.g. `Foo.Nested`.
