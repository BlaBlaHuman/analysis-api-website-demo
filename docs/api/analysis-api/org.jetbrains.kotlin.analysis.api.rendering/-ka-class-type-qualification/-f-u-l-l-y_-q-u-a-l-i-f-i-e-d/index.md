...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">FULLY_QUALIFIED</a>

</span></code></pre></div>The fully qualified name, including the package, e.g. `org.example.Foo.Nested`.
