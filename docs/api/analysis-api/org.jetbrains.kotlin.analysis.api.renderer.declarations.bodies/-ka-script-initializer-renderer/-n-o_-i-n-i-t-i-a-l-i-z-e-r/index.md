...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="index.html">NO_INITIALIZER</a> : <a href="../index.html">KaScriptInitializerRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#renderinitializer"><span class="nf">renderInitializer</span></a><span class="p">(</span>
