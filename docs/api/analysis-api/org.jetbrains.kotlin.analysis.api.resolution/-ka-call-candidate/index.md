...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="index.html">KaCallCandidate</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>[`KaCallCandidate`](index.md) represents one of the candidates considered during [overload resolution](https://kotlinlang.org/spec/overload-resolution.html) of a call.

In contrast to [`KaSimpleCallResolutionError.candidateCalls`](../-ka-simple-call-resolution-error/index.md#candidatecalls), retrieving a call candidate represented by [`KaCallCandidate`](index.md) doesn't imply that the call is erroneous or ambiguous. Rather, resolving all call candidates is helpful when analyzing all possible options at the call site.

#### See also


 - [`KaResolver.collectCallCandidates`](../../org.jetbrains.kotlin.analysis.api.components/-ka-resolver/index.md#collectcallcandidates)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-inapplicable-call-candidate/index.html#candidate">candidate</a><span class="o">: </span><a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a>
</span></code></pre></div>
</div>
...
The [`KaSimpleOrMultiCall`](../-ka-simple-or-multi-call/index.md) representing the call candidate.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-inapplicable-call-candidate/index.html#isinbestcandidates">isInBestCandidates</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the [`candidate`](../-ka-inapplicable-call-candidate/index.md#candidate) is in the final set of candidates considered during the call's resolution. There can be multiple best candidates if the call is ambiguous.
