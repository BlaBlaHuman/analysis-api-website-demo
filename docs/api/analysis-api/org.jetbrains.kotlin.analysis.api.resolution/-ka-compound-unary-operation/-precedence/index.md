...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">enum class </span><a href="index.html">Precedence</a> : <a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-enum/index.html">Enum</a><span class="o"><</span><a href="index.html">KaCompoundUnaryOperation.Precedence</a><span class="o">> </span>
</span></code></pre></div>
</div>

## Entries
### [`PREFIX`](-p-r-e-f-i-x/index.md)

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="-p-r-e-f-i-x/index.html">PREFIX</a>

</span></code></pre></div>The operator is a prefix of the operand (e.g. `++a`).


</div>

### [`POSTFIX`](-p-o-s-t-f-i-x/index.md)

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="-p-o-s-t-f-i-x/index.html">POSTFIX</a>

</span></code></pre></div>The operator is a suffix of the operand (e.g. `a++`).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#entries">entries</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.enums/-enum-entries/index.html">EnumEntries</a><span class="o"><</span><a href="index.html">KaCompoundUnaryOperation.Precedence</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="index.html#values"><span class="nf">values</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-array/index.html">Array</a><span class="o"><</span><a href="index.html">KaCompoundUnaryOperation.Precedence</a><span class="o">></span>
</span></code></pre></div>
</div>
