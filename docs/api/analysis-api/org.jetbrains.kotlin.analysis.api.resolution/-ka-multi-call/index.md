...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="index.html">KaMultiCall</a> : <a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a>
</span></code></pre></div>Represents a successful resolution resulting in multiple calls.
...
`int++` call will be represented as a [`KaMultiCall`](index.md) with two [`KaSimpleCall`](../-ka-simple-call/index.md)s inside: one for the `int` property and one for the `++` operator function ([`Int.inc`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/inc.html))
...
The flattened list of [`KaSimpleCall`](../-ka-simple-call/index.md)s.
 ...
 - If [`this`](../-ka-simple-or-multi-call/index.md) is an instance of [`KaMultiCall`](index.md), the list will contain [`KaMultiCall.calls`](../-ka-for-loop-call/index.md#calls)
...
[`this`](../-ka-simple-or-multi-call/index.md) call as a [`KaSimpleCall`](../-ka-simple-call/index.md), or `null` if it is a [`KaMultiCall`](index.md).
...
For `int = 2`, [`simple`](../-ka-for-loop-call/index.md#simple) is the write access to `int`. For `int++`, which is a [`KaMultiCall`](index.md), [`simple`](../-ka-for-loop-call/index.md#simple) is `null`.
...
The flattened list of [`KaSymbol`](../../org.jetbrains.kotlin.analysis.api.symbols/-ka-symbol/index.md)s for the resolved calls.
 ...
 - If [`this`](../-ka-simple-or-multi-call/index.md) is an instance of [`KaMultiCall`](index.md), the list will contain symbols from all [`KaMultiCall.calls`](../-ka-for-loop-call/index.md#calls)
