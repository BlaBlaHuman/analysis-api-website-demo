...
tags:
 - jvm
title: "KaForLoopCallResolutionAttempt"
---
...
<span class="kd">interface </span><a href="index.html">KaForLoopCallResolutionAttempt</a> : <a href="../-ka-multi-call-resolution-attempt/index.html">KaMultiCallResolutionAttempt</a>
</span></code></pre></div>Represents an attempt to resolve a `for` loop, which desugars into three operator calls: [`iterator()`](index.md#iteratorcallattempt), [`hasNext()`](index.md#hasnextcallattempt), and [`next()`](index.md#nextcallattempt).

When all sub-calls succeed, [`call`](index.md#call) contains the assembled [`KaForLoopCall`](../-ka-for-loop-call/index.md). When any sub-call fails, [`call`](index.md#call) is `null` but individual attempts still contain their resolution results.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#call">call</a><span class="o">: </span><a href="../-ka-for-loop-call/index.html">KaForLoopCall</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The assembled [`KaForLoopCall`](../-ka-for-loop-call/index.md), or `null` if any sub-call failed.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hasnextcallattempt">hasNextCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaForLoopCall.hasNextCall`](../-ka-for-loop-call/index.md#hasnextcall)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#iteratorcallattempt">iteratorCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaForLoopCall.iteratorCall`](../-ka-for-loop-call/index.md#iteratorcall)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#nextcallattempt">nextCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaForLoopCall.nextCall`](../-ka-for-loop-call/index.md#nextcall)
