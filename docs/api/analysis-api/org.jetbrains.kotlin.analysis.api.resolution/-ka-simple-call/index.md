...
<span class="kd">interface </span><a href="index.html">KaSimpleCall</a><span class="o"><</span><a href="index.html">S</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-callable-symbol/index.html">KaCallableSymbol</a><span class="p">, </span><a href="index.html">C</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.signatures/-ka-callable-signature/index.html">KaCallableSignature</a><span class="o"><</span><a href="index.html">S</a><span class="o">></span><span class="o">></span> : <a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a>
</span></code></pre></div>Represents a successful resolution resulting in a simple call.
...
`function()` call will be represented as a [`KaSimpleCall`](index.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a><span class="p">.</span><a href="../-ka-for-loop-call/index.html#calls">calls</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="index.html">KaSimpleCall</a><span class="o"><</span><span class="o">*</span><span class="p">, </span><span class="o">*</span><span class="o">></span><span class="o">></span>
</span></code></pre></div>
</div>
...
The flattened list of [`KaSimpleCall`](index.md)s.

 - If [`this`](../-ka-simple-or-multi-call/index.md) is an instance of [`KaSimpleCall`](index.md), the list will contain only [`this`](../-ka-simple-or-multi-call/index.md) call
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a><span class="p">.</span><a href="../-ka-for-loop-call/index.html#simple">simple</a><span class="o">: </span><a href="index.html">KaSimpleCall</a><span class="o"><</span><span class="o">*</span><span class="p">, </span><span class="o">*</span><span class="o">></span><span class="o">?</span>
</span></code></pre></div>
</div>
...
[`this`](../-ka-simple-or-multi-call/index.md) call as a [`KaSimpleCall`](index.md), or `null` if it is a [`KaMultiCall`](../-ka-multi-call/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><span class="o"><</span><a href="index.html#symbol">S</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-callable-symbol/index.html">KaCallableSymbol</a><span class="p">, </span><a href="index.html#symbol">C</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.signatures/-ka-callable-signature/index.html">KaCallableSignature</a><span class="o"><</span><a href="index.html#symbol">S</a><span class="o">></span><span class="o">> </span><a href="index.html">KaSimpleCall</a><span class="o"><</span><a href="index.html#symbol">S</a><span class="p">, </span><a href="index.html#symbol">C</a><span class="o">></span><span class="p">.</span><a href="index.html#symbol">symbol</a><span class="o">: </span><a href="index.html#symbol">S</a>
</span></code></pre></div>
</div>
...
The resolved [`KaCallableSymbol`](../../org.jetbrains.kotlin.analysis.api.symbols/-ka-callable-symbol/index.md) of the [`KaSimpleCall`](index.md).
...
The flattened list of [`KaSymbol`](../../org.jetbrains.kotlin.analysis.api.symbols/-ka-symbol/index.md)s for the resolved calls.
 ...
 - If [`this`](../-ka-simple-or-multi-call/index.md) is an instance of [`KaSimpleCall`](index.md), the list will contain only the [`KaSimpleCall.signature`](index.md#signature)'s symbol
...
A map of inferred type arguments. If type placeholders were used, the actual inferred type will be used as a value. The keys for this map are from [`signature`](index.md#signature)'s type parameters.
