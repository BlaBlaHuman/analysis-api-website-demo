...
tags:
 - jvm
title: "KaDelegatedPropertyCallResolutionAttempt"
---
...
<span class="kd">interface </span><a href="index.html">KaDelegatedPropertyCallResolutionAttempt</a> : <a href="../-ka-multi-call-resolution-attempt/index.html">KaMultiCallResolutionAttempt</a>
</span></code></pre></div>Represents an attempt to resolve a delegated property, which desugars into up to three operator calls: [`getValue()`](index.md#valuegettercallattempt), [`setValue()`](index.md#valuesettercallattempt), and [`provideDelegate()`](index.md#providedelegatecallattempt).

When all sub-calls succeed, [`call`](index.md#call) contains the assembled [`KaDelegatedPropertyCall`](../-ka-delegated-property-call/index.md). When any sub-call fails, [`call`](index.md#call) is `null` but individual attempts still contain their resolution results.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#call">call</a><span class="o">: </span><a href="../-ka-delegated-property-call/index.html">KaDelegatedPropertyCall</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The assembled [`KaDelegatedPropertyCall`](../-ka-delegated-property-call/index.md), or `null` if any sub-call failed.
...
### provideDelegateCallAttempt

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#providedelegatecallattempt">provideDelegateCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaDelegatedPropertyCall.provideDelegateCall`](../-ka-delegated-property-call/index.md#providedelegatecall)
...
### valueGetterCallAttempt

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#valuegettercallattempt">valueGetterCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaDelegatedPropertyCall.valueGetterCall`](../-ka-delegated-property-call/index.md#valuegettercall)
...
### valueSetterCallAttempt

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#valuesettercallattempt">valueSetterCallAttempt</a><span class="o">: </span><a href="../-ka-simple-call-resolution-attempt/index.html">KaSimpleCallResolutionAttempt</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`KaDelegatedPropertyCall.valueSetterCall`](../-ka-delegated-property-call/index.md#valuesettercall)
