...
<span class="kd">interface </span><a href="index.html">KaCallableReferenceCall</a><span class="o"><</span><a href="index.html">S</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols/-ka-callable-symbol/index.html">KaCallableSymbol</a><span class="p">, </span><a href="index.html">C</a><span class="o"> : </span><a href="../../org.jetbrains.kotlin.analysis.api.signatures/-ka-callable-signature/index.html">KaCallableSignature</a><span class="o"><</span><a href="index.html">S</a><span class="o">></span><span class="o">></span> : <a href="../-ka-simple-call/index.html">KaSimpleCall</a><span class="o"><</span><a href="index.html">S</a><span class="p">, </span><a href="index.html">C</a><span class="o">> </span>
</span></code></pre></div>A [callable reference](https://kotlinlang.org/docs/reflection.html#function-references) to a function, a property, or a constructor.
...
Each of the references above is represented as a [`KaCallableReferenceCall`](index.md).

Unlike [`KaFunctionCall`](../-ka-function-call/index.md) or [`KaVariableAccessCall`](../-ka-variable-access-call/index.md), a callable reference does not actually invoke the callable, so it has no value-argument mapping nor a read/write access kind — only the [`signature`](../-ka-simple-call/index.md#signature) of the referenced callable, the bound [`dispatch`](../-ka-simple-call/index.md#dispatchreceiver)/[`extension`](../-ka-simple-call/index.md#extensionreceiver)/[`context`](../-ka-simple-call/index.md#contextarguments) receivers, and the [`type-argument mapping`](../-ka-simple-call/index.md#typeargumentsmapping).

#### See also


 - [`KaResolver`](../../org.jetbrains.kotlin.analysis.api.components/-ka-resolver/index.md)
 - [`KtCallableReferenceExpression`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-callable-reference-expression/index.md)
