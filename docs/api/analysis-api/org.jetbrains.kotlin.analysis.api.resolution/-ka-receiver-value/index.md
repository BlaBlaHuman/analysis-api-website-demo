...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="index.html">KaReceiverValue</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>A [receiver](https://kotlin.github.io/analysis-api/receivers.html) value of a call, which represents either an [`explicit`](../-ka-explicit-receiver-value/index.md), [`implicit`](../-ka-implicit-receiver-value/index.md), or [`smart-casted`](../-ka-smart-casted-receiver-value/index.md) receiver.
