...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="-kind/index.html">Kind</a>
</span></code></pre></div>
</div>
...
Determines the kind of access to the [`variable`](index.md) (read or write), alongside additional information
...
For `function()`, [`function`](../-ka-for-loop-call/index.md#function) is the call to `function`. For `int`, which is a [`KaVariableAccessCall`](index.md), [`function`](../-ka-for-loop-call/index.md#function) is `null`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#iscontextsensitive">isContextSensitive</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#kind">kind</a><span class="o">: </span><a href="-kind/index.html">KaVariableAccessCall.Kind</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="../-ka-simple-or-multi-call/index.html">KaSimpleOrMultiCall</a><span class="p">.</span><a href="../-ka-for-loop-call/index.html#variable">variable</a><span class="o">: </span><a href="index.html">KaVariableAccessCall</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
[`this`](../-ka-simple-or-multi-call/index.md) call as a [`KaVariableAccessCall`](index.md), or `null` if it is not an access to a variable.
