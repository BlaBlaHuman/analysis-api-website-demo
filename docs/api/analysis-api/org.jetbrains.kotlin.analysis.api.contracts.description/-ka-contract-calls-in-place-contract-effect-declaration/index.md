...
tags:
 - jvm
title: "KaContractCallsInPlaceContractEffectDeclaration"
---
...
<span class="kd">interface </span><a href="index.html">KaContractCallsInPlaceContractEffectDeclaration</a> : <a href="../-ka-contract-effect-declaration/index.html">KaContractEffectDeclaration</a>
</span></code></pre></div>Represents [`kotlin.contracts.ContractBuilder.callsInPlace`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/calls-in-place.html).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#invocationkind">invocationKind</a><span class="o">: </span><a href="../-ka-contract-invocation-kind/index.html">KaContractInvocationKind</a>
</span></code></pre></div>
</div>
...
Describes how many times the [`valueParameterReference`](index.md#valueparameterreference) is invoked by a function.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#valueparameterreference">valueParameterReference</a><span class="o">: </span><a href="../-ka-contract-parameter-value/index.html">KaContractParameterValue</a>
</span></code></pre></div>
</div>
