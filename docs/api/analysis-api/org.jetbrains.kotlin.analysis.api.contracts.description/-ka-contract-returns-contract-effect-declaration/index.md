...
tags:
 - jvm
title: "KaContractReturnsContractEffectDeclaration"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">interface </span><a href="index.html">KaContractReturnsContractEffectDeclaration</a> : <a href="../-ka-contract-effect-declaration/index.html">KaContractEffectDeclaration</a>
</span></code></pre></div>Represents [`kotlin.contracts.ContractBuilder.returnsNotNull`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns-not-null.html)&[`kotlin.contracts.ContractBuilder.returns`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns.html).

#### Inheritors


 - [`KaContractReturnsNotNullEffectDeclaration`](-ka-contract-returns-not-null-effect-declaration/index.md)
 - [`KaContractReturnsSpecificValueEffectDeclaration`](-ka-contract-returns-specific-value-effect-declaration/index.md)
 - [`KaContractReturnsSuccessfullyEffectDeclaration`](-ka-contract-returns-successfully-effect-declaration/index.md)
...
<span class="kd">interface </span><a href="-ka-contract-returns-not-null-effect-declaration/index.html">KaContractReturnsNotNullEffectDeclaration</a> : <a href="index.html">KaContractReturnsContractEffectDeclaration</a>
</span></code></pre></div>
</div>
...
Represents [`kotlin.contracts.ContractBuilder.returnsNotNull`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns-not-null.html).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-subclass-opt-in-required/index.html"><span class="se">SubclassOptInRequired</span></a><span class="p">(</span>markerClass<span class="o"> = </span><span class="p">[</span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-implementation-detail/index.html">KaImplementationDetail::class</a><span class="p">]</span><span class="p">)</span>
<span class="kd">interface </span><a href="-ka-contract-returns-specific-value-effect-declaration/index.html">KaContractReturnsSpecificValueEffectDeclaration</a> : <a href="index.html">KaContractReturnsContractEffectDeclaration</a>
</span></code></pre></div>
</div>
...
Represents [`kotlin.contracts.ContractBuilder.returns`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns.html) with a `value` argument.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="se">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-subclass-opt-in-required/index.html"><span class="se">SubclassOptInRequired</span></a><span class="p">(</span>markerClass<span class="o"> = </span><span class="p">[</span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-implementation-detail/index.html">KaImplementationDetail::class</a><span class="p">]</span><span class="p">)</span>
<span class="kd">interface </span><a href="-ka-contract-returns-successfully-effect-declaration/index.html">KaContractReturnsSuccessfullyEffectDeclaration</a> : <a href="index.html">KaContractReturnsContractEffectDeclaration</a>
</span></code></pre></div>
</div>
...
Represents [`kotlin.contracts.ContractBuilder.returns`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns.html) without arguments.
