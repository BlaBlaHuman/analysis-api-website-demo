...
tags:
 - jvm
title: "KaContractReturnsSpecificValueEffectDeclaration"
---
...
<span class="kd">interface </span><a href="index.html">KaContractReturnsSpecificValueEffectDeclaration</a> : <a href="../index.html">KaContractReturnsContractEffectDeclaration</a>
</span></code></pre></div>Represents [`kotlin.contracts.ContractBuilder.returns`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.contracts/-contract-builder/returns.html) with a `value` argument.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#value">value</a><span class="o">: </span><a href="../../-ka-contract-constant-value/index.html">KaContractConstantValue</a>
</span></code></pre></div>
</div>
