...
tags:
 - jvm
title: "INIT_BLOCK_WITH_BRACES"
---

# INIT_BLOCK_WITH_BRACES

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="index.html">INIT_BLOCK_WITH_BRACES</a> : <a href="../index.html">KaClassInitializerRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#renderclassinitializer"><span class="nf">renderClassInitializer</span></a><span class="p">(</span>
