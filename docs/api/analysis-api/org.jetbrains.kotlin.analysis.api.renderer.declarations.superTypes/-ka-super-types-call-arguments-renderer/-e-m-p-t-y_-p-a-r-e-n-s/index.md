...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">object </span><a href="index.html">EMPTY_PARENS</a> : <a href="../index.html">KaSuperTypesCallArgumentsRenderer</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#rendersupertypearguments"><span class="nf">renderSuperTypeArguments</span></a><span class="p">(</span>
