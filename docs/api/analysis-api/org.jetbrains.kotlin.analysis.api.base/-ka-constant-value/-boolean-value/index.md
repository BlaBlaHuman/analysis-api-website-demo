...
<span class="kd">interface </span><a href="index.html">BooleanValue</a> : <a href="../index.html">KaConstantValue</a>
</span></code></pre></div>Represents a [`Boolean`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html) value.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#value">value</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
The value of the constant. The type of [`value`](../-null-value/index.md#value) matches its represented class, e.g. [`BooleanValue.value`](index.md#value) is a [`Boolean`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html).
