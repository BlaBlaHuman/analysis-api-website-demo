...
<span class="kd">interface </span><a href="index.html">UByteValue</a> : <a href="../index.html">KaConstantValue</a>
</span></code></pre></div>Represents a [`UByte`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-u-byte/index.html) value.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#value">value</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-u-byte/index.html">UByte</a>
</span></code></pre></div>
</div>
