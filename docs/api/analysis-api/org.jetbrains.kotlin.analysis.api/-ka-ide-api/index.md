...
<span class="kd">annotation class </span><a href="index.html">KaIdeApi</a>
...
The motivation behind [`KaIdeApi`](index.md) is the following: in a few cases, implementing functionality in the Analysis API is more efficient or more straightforward than implementing it in the Kotlin IntelliJ plugin. The resulting API is normally too specific to be considered a general, public part of the Analysis API.
