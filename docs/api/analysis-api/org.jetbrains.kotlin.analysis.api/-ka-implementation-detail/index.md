...
<span class="kd">annotation class </span><a href="index.html">KaImplementationDetail</a>
</span></code></pre></div>Marks an API as an implementation detail of the Analysis API. Such APIs are not intended to be used outside the implementation of the Analysis API and have no compatibility guarantees.

While the Analysis API generally strives to hide implementation details from users, due to architectural reasons, some implementation details cannot be moved out of the API surface for now.
