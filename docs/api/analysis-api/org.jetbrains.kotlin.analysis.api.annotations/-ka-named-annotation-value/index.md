...
<span class="kd">interface </span><a href="index.html">KaNamedAnnotationValue</a> : <a href="../../org.jetbrains.kotlin.analysis.api.lifetime/-ka-lifetime-owner/index.html">KaLifetimeOwner</a>
</span></code></pre></div>A name/value pair representing an annotation argument.
...
The annotation application `@Foo(bar = "abc")` has a single [`KaNamedAnnotationValue`](index.md) `bar = "abc"`, with the name "bar" and a [`KaAnnotationValue.ConstantValue`](../-ka-annotation-value/-constant-value/index.md) representing the [`String`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html) constant `"abc"`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#expression">expression</a><span class="o">: </span><a href="../-ka-annotation-value/index.html">KaAnnotationValue</a>
</span></code></pre></div>
</div>
