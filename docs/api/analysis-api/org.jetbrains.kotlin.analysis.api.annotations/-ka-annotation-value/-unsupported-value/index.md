...
<span class="kd">interface </span><a href="index.html">UnsupportedValue</a> : <a href="../index.html">KaAnnotationValue</a>
</span></code></pre></div>Represents an unsupported expression used as an annotation value.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">fun </span><a href="../index.html">KaAnnotationValue</a><span class="p">.</span><a href="index.html#renderassourcecode"><span class="nf">renderAsSourceCode</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a>
</span></code></pre></div>
</div>
