...
<span class="kd">interface </span><a href="index.html">EnumEntryValue</a> : <a href="../index.html">KaAnnotationValue</a>
</span></code></pre></div>An enum entry annotation value, such as `Color.RED`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#callableid">callableId</a><span class="o">: </span>CallableId<span class="o">?</span>
</span></code></pre></div>
</div>
