...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaEnumEntrySymbol</a> : <a href="../-ka-variable-symbol/index.html">KaVariableSymbol</a>
</span></code></pre></div>[`KaEnumEntrySymbol`](index.md) represents an [enum entry declaration](https://kotlinlang.org/docs/enum-classes.html).

Note that even though the PSI representation [`KtEnumEntry`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-enum-entry/index.md) is a [`KtClass`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-class/index.md), in Analysis API and the compiler an enum entry is seen as [`KaVariableSymbol`](../-ka-variable-symbol/index.md).
...
Members declared by the enum class and overridden in the enum entry's body will be accessible, of course, but only the base version declared in the enum class. For example, the narrowed return type of an overridden member in an enum entry's body will not be visible outside the body.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#initializer">initializer</a><span class="o">: </span><a href="../-ka-anonymous-object-symbol/index.html">KaAnonymousObjectSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The enum entry's [initializer](https://kotlinlang.org/docs/enum-classes.html#anonymous-classes), or `null` if the enum entry doesn't have a body.
...
<strong>Note</strong>:
 ...
 - According to the KEEP, [`KaEnumEntrySymbol`](index.md) (and its generated callables like `valueOf`) are also considered implicitly declared in a companion block.
...
## Functions
### [`asPsiField`](../../org.jetbrains.kotlin.analysis.api.javaInterop/as-psi-field.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">context</span><span class="p">(</span>session<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-session/index.html">KaSession</a><span class="p">)</span>
<span class="kd">fun </span><a href="index.html">KaEnumEntrySymbol</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.analysis.api.javaInterop/as-psi-field.html"><span class="nf">asPsiField</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span>PsiEnumConstant<span class="o">?</span>
</span></code></pre></div>
</div>
...
Converts the given [`KaEnumEntrySymbol`](index.md) to Java PsiEnumConstant in the context of the [`useSiteModule`](../../../analysis-api/org.jetbrains.kotlin.analysis.api/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createpointer"><span class="nf">createPointer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols.pointers/-ka-symbol-pointer/index.html">KaSymbolPointer</a><span class="o"><</span><a href="index.html">KaEnumEntrySymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
