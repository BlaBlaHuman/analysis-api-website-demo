...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">TOP_LEVEL</a>

</span></code></pre></div>Symbols which are not a part of other symbols.

Examples: [`KaFileSymbol`](../../-ka-file-symbol/index.md), [`KaScriptSymbol`](../../-ka-script-symbol/index.md), [`KaPackageSymbol`](../../-ka-package-symbol/index.md), and top-level declarations.
