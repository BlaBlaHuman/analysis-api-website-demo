...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">sealed </span><span class="kd">class </span><a href="index.html">KaPropertySymbol</a> : <a href="../-ka-variable-symbol/index.html">KaVariableSymbol</a>
</span></code></pre></div>[`KaPropertySymbol`](index.md) represents a [property declaration](https://kotlinlang.org/docs/properties.html).
...
Depending on this callable symbol, the sequence contains:
 ...
 - [`KaPropertySymbol`](index.md), including [`KaSyntheticJavaPropertySymbol`](../-ka-synthetic-java-property-symbol/index.md): overridden property symbols.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-kotlin-property-symbol/index.html#backingfieldsymbol">backingFieldSymbol</a><span class="o">: </span><a href="../-ka-backing-field-symbol/index.html">KaBackingFieldSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
[`hasBackingField`](../-ka-kotlin-property-symbol/index.md#hasbackingfield) can be used to check whether the backing field is not default one.
...
**See also**
 ...
 - [`hasBackingField`](../-ka-kotlin-property-symbol/index.md#hasbackingfield)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-kotlin-property-symbol/index.html#getter">getter</a><span class="o">: </span><a href="../-ka-property-getter-symbol/index.html">KaPropertyGetterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-kotlin-property-symbol/index.html#hasbackingfield">hasBackingField</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
**See also**
 ...
 - [`backingFieldSymbol`](../-ka-kotlin-property-symbol/index.md#backingfieldsymbol)
 - [`isDelegated`](../-ka-local-variable-symbol/index.md#isdelegated)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-kotlin-property-symbol/index.html#hasgetter">hasGetter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the property has a non-null [`getter`](../-ka-kotlin-property-symbol/index.md#getter).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createpointer"><span class="nf">createPointer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols.pointers/-ka-symbol-pointer/index.html">KaSymbolPointer</a><span class="o"><</span><a href="index.html">KaPropertySymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
