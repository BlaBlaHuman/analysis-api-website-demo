...
</span></code></pre></div>Describes the implementation state of a [`KaCallableSymbol`](../-ka-callable-symbol/index.md) in the context of a specific [`KaClassSymbol`](../-ka-class-symbol/index.md).
...
#### See also
 ...
 - [`implementationState`](../-ka-receiver-parameter-symbol/index.md#implementationstate)
