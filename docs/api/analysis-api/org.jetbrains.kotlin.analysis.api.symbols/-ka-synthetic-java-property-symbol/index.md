...
tags:
 - jvm
title: "KaSyntheticJavaPropertySymbol"
---
...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaSyntheticJavaPropertySymbol</a> : <a href="../-ka-property-symbol/index.html">KaPropertySymbol</a>
</span></code></pre></div>[`KaSyntheticJavaPropertySymbol`](index.md) represents a synthetic property generated by the compiler for a Java field associated with a getter or setter. This allows Java fields to be accessed like Kotlin properties.
...
#### See also
 ...
 - [`KaSymbolOrigin.JAVA_SYNTHETIC_PROPERTY`](../-ka-symbol-origin/-j-a-v-a_-s-y-n-t-h-e-t-i-c_-p-r-o-p-e-r-t-y/index.md)
...
Depending on this callable symbol, the sequence contains:
 ...
 - Java [`KaNamedFunctionSymbol`](../-ka-named-function-symbol/index.md) that corresponds to the getter or setter of a [`KaSyntheticJavaPropertySymbol`](index.md): the same property symbols as the corresponding synthetic property accessor, not Java accessor methods.


 - [`KaPropertySymbol`](../-ka-property-symbol/index.md), including [`KaSyntheticJavaPropertySymbol`](index.md): overridden property symbols.
...
The sequence may include [`KaSyntheticJavaPropertySymbol`](index.md)s in Java/Kotlin hierarchies.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="index.html#backingfieldsymbol">backingFieldSymbol</a><span class="o">: </span><a href="../-ka-backing-field-symbol/index.html">KaBackingFieldSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#getter">getter</a><span class="o">: </span><a href="../-ka-property-getter-symbol/index.html">KaPropertyGetterSymbol</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="index.html#hasbackingfield">hasBackingField</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="index.html#hasgetter">hasGetter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hassetter">hasSetter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the property has a non-null [`setter`](index.md#setter).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#initializer">initializer</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-initializer-value/index.html">KaInitializerValue</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isactual">isActual</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#iscompanion">isCompanion</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isexpect">isExpect</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isexternal">isExternal</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<strong>Note</strong>: <strong>true</strong> doesn't guarantee the property is a Java one as Kotlin properties internally might be treated as static, but their behavior is not specified. Consider using [`isCompanion`](index.md#iscompanion).

**See also**



 - [`isCompanion`](index.md#iscompanion)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#javagettersymbol">javaGetterSymbol</a><span class="o">: </span><a href="../-ka-named-function-symbol/index.html">KaNamedFunctionSymbol</a>
</span></code></pre></div>
</div>
...
In the synthetic property for `field`, [`javaGetterSymbol`](index.md#javagettersymbol) is the function symbol for `getField`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#javasettersymbol">javaSetterSymbol</a><span class="o">: </span><a href="../-ka-named-function-symbol/index.html">KaNamedFunctionSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
In the synthetic property for `field`, [`javaSetterSymbol`](index.md#javasettersymbol) is the function symbol for `setField`.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#modality">modality</a><span class="o">: </span><a href="../-ka-symbol-modality/index.html">KaSymbolModality</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#receiverparameter">receiverParameter</a><span class="o">: </span><a href="../-ka-receiver-parameter-symbol/index.html">KaReceiverParameterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The receiver parameter is present both for regular [`extensions`](index.md#isextension) and for [`companion extensions`](index.md#iscompanion).
...
The [`receiver parameter`](index.md#receiverparameter)'s type, or `null` if the callable has no receiver.

**See also**



 - [`KaCallableSymbol.receiverParameter`](index.md#receiverparameter)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#setter">setter</a><span class="o">: </span><a href="../-ka-property-setter-symbol/index.html">KaPropertySetterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#visibility">visibility</a><span class="o">: </span><a href="../-ka-symbol-visibility/index.html">KaSymbolVisibility</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createpointer"><span class="nf">createPointer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols.pointers/-ka-symbol-pointer/index.html">KaSymbolPointer</a><span class="o"><</span><a href="index.html">KaSyntheticJavaPropertySymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
