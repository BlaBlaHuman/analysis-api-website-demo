...
</span></code></pre></div>The return value status of the function (should it be used, or can it be ignored).

#### See also


 - [`returnValueStatus`](../-ka-named-function-symbol/index.md#returnvaluestatus)
