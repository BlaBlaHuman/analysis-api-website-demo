...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">JAVA_LIBRARY</a>

</span></code></pre></div>A declaration from a compiled Java library.

In contrast to [`LIBRARY`](../-l-i-b-r-a-r-y/index.md), a [`JAVA_LIBRARY`](index.md) declaration comes from compiled Java code. The Kotlin compiler can tell the difference by the absence of Kotlin class metadata.
