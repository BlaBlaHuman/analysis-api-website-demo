...
tags:
 - jvm
title: "NATIVE_FORWARD_DECLARATION"
---
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">NATIVE_FORWARD_DECLARATION</a>

</span></code></pre></div>A Kotlin/Native forward declaration.

See the [forward declarations](https://kotlinlang.org/docs/multiplatform-compatibility-guide.html#new-approach-to-forward-declarations) section in the Kotlin documentation.
