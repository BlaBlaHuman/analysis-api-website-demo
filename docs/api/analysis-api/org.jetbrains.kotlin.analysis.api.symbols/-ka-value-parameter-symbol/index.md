...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaValueParameterSymbol</a> : <a href="../-ka-parameter-symbol/index.html">KaParameterSymbol</a>
</span></code></pre></div>[`KaValueParameterSymbol`](index.md) represents a value parameter of a function, constructor, or property setter.

In Kotlin, we generally use the phrase "value parameter," as functions have different kinds of parameters, such as value, receiver, context, and type parameters.

#### See also


 - [`KaFunctionSymbol.valueParameters`](../-ka-property-accessor-symbol/index.md#valueparameters)
...
Depending on this callable symbol, the sequence contains:
 ...
 - [`KaValueParameterSymbol`](index.md) with [`KaValueParameterSymbol.primaryConstructorProperty`](index.md#primaryconstructorproperty): overridden symbols of that generated property.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#callableid">callableId</a><span class="o">: </span>CallableId<span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#contextreceivers">contextReceivers</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.base/-ka-context-receiver/index.html">KaContextReceiver</a><span class="o">></span>
</span></code></pre></div>
</div>
...
### hasDeclaredDefaultValue

<div class="dokka-symbol-block" style="background: color-mix(in srgb, var(--md-code-bg-color) 30%, transparent); margin-top: 0.5rem; padding: 1px .7rem .2rem .7rem; border-radius: 0.5rem;" markdown>

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hasdeclareddefaultvalue">hasDeclaredDefaultValue</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Indicates whether the parameter has an explicitly declared [default value](https://kotlinlang.org/docs/functions.html#parameters-with-default-values). Unlike [`hasDefaultValue`](index.md#hasdefaultvalue), this property does not consider overridden functions or `expect`/`actual` declarations.

**See also**



 - [`hasDefaultValue`](index.md#hasdefaultvalue)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hasdefaultvalue">hasDefaultValue</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Indicates whether the parameter has a [default value](https://kotlinlang.org/docs/functions.html#parameters-with-default-values), meaning the argument can be omitted when calling the corresponding function.
...
**See also**
 ...
 - [`hasDeclaredDefaultValue`](index.md#hasdeclareddefaultvalue)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isactual">isActual</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#iscompanion">isCompanion</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#iscrossinline">isCrossinline</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isdelegated">isDelegated</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isexpect">isExpect</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isextension">isExtension</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isexternal">isExternal</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isimplicitlambdaparameter">isImplicitLambdaParameter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isnoinline">isNoinline</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#isval">isVal</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isvararg">isVararg</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#location">location</a><span class="o">: </span><a href="../-ka-symbol-location/index.html">KaSymbolLocation</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#modality">modality</a><span class="o">: </span><a href="../-ka-symbol-modality/index.html">KaSymbolModality</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">val </span><a href="index.html#name">name</a><span class="o">: </span>Name
</span></code></pre></div>
</div>
...
For a parameter of `FunctionN.invoke()` functions, the name is taken from the function type notation, if a name is present. For example:
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">open </span><span class="kd">val </span><a href="index.html#primaryconstructorproperty">primaryConstructorProperty</a><span class="o">: </span><a href="../-ka-kotlin-property-symbol/index.html">KaKotlinPropertySymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The associated generated [`KaPropertySymbol`](../-ka-property-symbol/index.md) if this value parameter corresponds to a `val` or `var` property declaration in a primary constructor.

**See also**



 - [`KaKotlinPropertySymbol.primaryConstructorParameter`](../-ka-kotlin-property-symbol/index.md#primaryconstructorparameter)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#receiverparameter">receiverParameter</a><span class="o">: </span><a href="../-ka-receiver-parameter-symbol/index.html">KaReceiverParameterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#typeparameters">typeParameters</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../-ka-type-parameter-symbol/index.html">KaTypeParameterSymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
...
### [`varargArrayType`](../../org.jetbrains.kotlin.analysis.api.types/vararg-array-type.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">context</span><span class="p">(</span>session<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-session/index.html">KaSession</a><span class="p">)</span>
<span class="kd">val </span><a href="index.html">KaValueParameterSymbol</a><span class="p">.</span><a href="../../org.jetbrains.kotlin.analysis.api.types/vararg-array-type.html">varargArrayType</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.types/-ka-type/index.html">KaType</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The array type that represents the list of arguments passed to this parameter if [`this`](index.md) is a [vararg](https://kotlinlang.org/docs/functions.html#variable-number-of-arguments-varargs) parameter.
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">override </span><span class="kd">val </span><a href="../-ka-receiver-parameter-symbol/index.html#visibility">visibility</a><span class="o">: </span><a href="../-ka-symbol-visibility/index.html">KaSymbolVisibility</a>
</span></code></pre></div>
</div>
...
## Functions
### [`asPsiParameters`](../../org.jetbrains.kotlin.analysis.api.javaInterop/as-psi-parameters.md)
...
Converts the given [`KaParameterSymbol`](../-ka-parameter-symbol/index.md) to Java PsiParameters in the context of the [`useSiteModule`](../../../analysis-api/org.jetbrains.kotlin.analysis.api/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createpointer"><span class="nf">createPointer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols.pointers/-ka-symbol-pointer/index.html">KaSymbolPointer</a><span class="o"><</span><a href="index.html">KaValueParameterSymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
...
Returns `null` if:
 ...
 - If the symbol is non-implementable (for example, it is a [`KaConstructorSymbol`](../-ka-constructor-symbol/index.md), or a [`KaValueParameterSymbol`](index.md)).
