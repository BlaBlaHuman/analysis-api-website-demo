...
<span class="kd">abstract </span><span class="kd">class </span><a href="index.html">KaKotlinPropertySymbol</a> : <a href="../-ka-property-symbol/index.html">KaPropertySymbol</a>
</span></code></pre></div>[`KaKotlinPropertySymbol`](index.md) represents a Kotlin property symbol, in contrast to [`KaSyntheticJavaPropertySymbol`](../-ka-synthetic-java-property-symbol/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#backingfieldsymbol">backingFieldSymbol</a><span class="o">: </span><a href="../-ka-backing-field-symbol/index.html">KaBackingFieldSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
[`hasBackingField`](index.md#hasbackingfield) can be used to check whether the backing field is not default one.
...
**See also**
 ...
 - [`hasBackingField`](index.md#hasbackingfield)
 - [`isDelegated`](../-ka-local-variable-symbol/index.md#isdelegated)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#contextreceivers">contextReceivers</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="o"><</span><a href="../../org.jetbrains.kotlin.analysis.api.base/-ka-context-receiver/index.html">KaContextReceiver</a><span class="o">></span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#getter">getter</a><span class="o">: </span><a href="../-ka-property-getter-symbol/index.html">KaPropertyGetterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hasbackingfield">hasBackingField</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether a [backing field](https://kotlinlang.org/docs/properties.html#backing-fields) is generated or [declared](https://github.com/Kotlin/KEEP/issues/278) for the property.

<strong>Important</strong>: this flag is properly supported for source declarations on all platforms, but for libraries it properly works only on supported platforms. Only Kotlin/JVM has this information in the metadata yet. Support for other platforms will be available as soon as a library is compiled with a compiler version that supports [KT-77281](https://youtrack.jetbrains.com/issue/KT-77281).

**Good to know**

On Kotlin/JVM compiled properties from annotations classes are compiled without a backing field, but for sources it is still <strong>true</strong>.

**See also**



 - [`backingFieldSymbol`](index.md#backingfieldsymbol)
 - [`isDelegated`](../-ka-local-variable-symbol/index.md#isdelegated)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#hasgetter">hasGetter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the property has a non-null [`getter`](index.md#getter).

To check if the property's getter is a <strong>custom</strong> getter, see [`KaPropertyGetterSymbol.isNotDefault`](../-ka-property-setter-symbol/index.md#isnotdefault).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-synthetic-java-property-symbol/index.html#hassetter">hasSetter</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
Whether the property has a non-null [`setter`](../-ka-synthetic-java-property-symbol/index.md#setter).

To check if the property's setter is a <strong>custom</strong> setter, see [`KaPropertySetterSymbol.isNotDefault`](../-ka-property-setter-symbol/index.md#isnotdefault).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-synthetic-java-property-symbol/index.html#initializer">initializer</a><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-initializer-value/index.html">KaInitializerValue</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
Possible cases are:
 ...
 - [`KaConstantInitializerValue`](../../org.jetbrains.kotlin.analysis.api/-ka-constant-initializer-value/index.md) - the property has an initializer with a compile-time constant value.


 - [`KaNonConstantInitializerValue`](../../org.jetbrains.kotlin.analysis.api/-ka-non-constant-initializer-value/index.md) - the property has an initializer with a non-constant value. If the initializer is declared in sources, the value includes the corresponding [`KtExpression`](../../../psi-api/org.jetbrains.kotlin.psi/-kt-expression/index.md).


 - [`KaConstantValueForAnnotation`](../../org.jetbrains.kotlin.analysis.api/-ka-constant-value-for-annotation/index.md) - the property is contained in an annotation class and has an initializer which can be evaluated to a [`KaAnnotationValue`](../../org.jetbrains.kotlin.analysis.api.annotations/-ka-annotation-value/index.md).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#isconst">isConst</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-local-variable-symbol/index.html#isdelegated">isDelegated</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">context</span><span class="p">(</span>session<span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api/-ka-session/index.html">KaSession</a><span class="p">)</span>
<span class="kd">val </span><a href="index.html">KaKotlinPropertySymbol</a><span class="p">.</span><a href="index.html#isinline">isInline</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-synthetic-java-property-symbol/index.html#isoverride">isOverride</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-synthetic-java-property-symbol/index.html#isstatic">isStatic</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<strong>Note</strong>: <strong>true</strong> doesn't guarantee the property is a Java one as Kotlin properties internally might be treated as static, but their behavior is not specified. Consider using [`isCompanion`](../-ka-synthetic-java-property-symbol/index.md#iscompanion).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-local-variable-symbol/index.html#isval">isVal</a><span class="o">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="index.html#primaryconstructorparameter">primaryConstructorParameter</a><span class="o">: </span><a href="../-ka-value-parameter-symbol/index.html">KaValueParameterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
The associated [`KaValueParameterSymbol`](../-ka-value-parameter-symbol/index.md) if this property is generated from a primary constructor parameter.

Properties may be declared directly in the primary constructor of a class. The compiler generates a property from such a declaration, which is initialized with the argument passed to the corresponding primary constructor parameter.
...
`Foo.name` is declared in `Foo`'s primary constructor. The compiler generates a corresponding property which is accessible via the class's [`member scope`](../../org.jetbrains.kotlin.analysis.api.components/-ka-scope-provider/index.md#memberscope), as well as the primary constructor's value parameters via [`KaValueParameterSymbol.generatedPrimaryConstructorProperty`](../../../analysis-api/org.jetbrains.kotlin.analysis.api.symbols/-ka-value-parameter-symbol/generated-primary-constructor-property.md).
...
**See also**
 ...
 - [`isFromPrimaryConstructor`](../../../analysis-api/org.jetbrains.kotlin.analysis.api.symbols/-ka-property-symbol/is-from-primary-constructor.md)
 - [`KaValueParameterSymbol.generatedPrimaryConstructorProperty`](../../../analysis-api/org.jetbrains.kotlin.analysis.api.symbols/-ka-value-parameter-symbol/generated-primary-constructor-property.md)
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">val </span><a href="../-ka-synthetic-java-property-symbol/index.html#setter">setter</a><span class="o">: </span><a href="../-ka-property-setter-symbol/index.html">KaPropertySetterSymbol</a><span class="o">?</span>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">abstract </span><span class="kd">override </span><span class="kd">fun </span><a href="index.html#createpointer"><span class="nf">createPointer</span></a><span class="p">(</span><span class="p">)</span><span class="o">: </span><a href="../../org.jetbrains.kotlin.analysis.api.symbols.pointers/-ka-symbol-pointer/index.html">KaSymbolPointer</a><span class="o"><</span><a href="index.html">KaKotlinPropertySymbol</a><span class="o">></span>
</span></code></pre></div>
</div>
