...
tags:
 - jvm
title: "KotlinFileBasedDeclarationProvider"
---

# KotlinFileBasedDeclarationProvider

<div markdown>

<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">class </span><a href="index.html">KotlinFileBasedDeclarationProvider</a><span class="p">(</span><span class="kd">val </span>kotlinFile<span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-file/index.html">KtFile</a><span class="p">)</span> : <a href="../-kotlin-declaration-provider/index.html">KotlinDeclarationProvider</a>
</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">constructor</span><span class="p">(</span>kotlinFile<span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-file/index.html">KtFile</a><span class="p">)</span>
</span></code></pre></div>
</div>
...
Whether the declaration provider has a specific implementation of [`computePackageNamesWithTopLevelCallables`](index.md#computepackagenameswithtoplevelcallables). This allows the Analysis API backend to determine whether callable package sets are computed and cached separately or with [`computePackageNames`](../-kotlin-declaration-provider/index.md#computepackagenames).
...
Whether the declaration provider has a specific implementation of [`computePackageNamesWithTopLevelClassifiers`](index.md#computepackagenameswithtoplevelclassifiers). This allows the Analysis API backend to determine whether classifier package sets are computed and cached separately or with [`computePackageNames`](../-kotlin-declaration-provider/index.md#computepackagenames).
...
<div class="highlight"><pre><code class="md-code__content"><span markdown><span class="kd">val </span><a href="index.html#kotlinfile">kotlinFile</a><span class="o">: </span><a href="../../../psi-api/org.jetbrains.kotlin.psi/-kt-file/index.html">KtFile</a>
</span></code></pre></div>
</div>
...
[`computePackageNames`](../-kotlin-declaration-provider/index.md#computepackagenames) is used as the default implementation for [`computePackageNamesWithTopLevelClassifiers`](index.md#computepackagenameswithtoplevelclassifiers) and [`computePackageNamesWithTopLevelCallables`](index.md#computepackagenameswithtoplevelcallables) if either returns `null`. It depends on the declaration provider whether it's worth computing separate package sets for classifiers and callables, or just one set containing all package names.
