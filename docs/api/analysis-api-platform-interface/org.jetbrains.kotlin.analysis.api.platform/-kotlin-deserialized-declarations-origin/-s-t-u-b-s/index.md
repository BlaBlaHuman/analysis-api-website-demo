...
<div class="highlight"><pre><code class="md-code__content"><span markdown><a href="index.html">STUBS</a>
...
This mode is used by the IntelliJ K2 plugin because libraries are already indexed in a stub format, and we can avoid additionally loading binaries.
